...
const options_entry osd_options::s_option_entries[] =
{
	...
	{ OSDOPTION_GLSLPATH,                        "hlsl",           core_options::option_type::PATH,      "path to GLSL shaders" },   // MAMEFX 20230204 Robbbert
	...
	{ OSDOPTION_GLSL_SYNC,                       "0",              core_options::option_type::BOOLEAN,   "enable OpenGL synchrony feature with performance loss (default off)" },
