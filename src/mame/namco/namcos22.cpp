...
Time Crisis        TS1CCRH.5B, TS1CCRH.1D                                                4M SOP32
                   ...
                   TS1CG6.18D, TS1SCG0.12F,TS1SCG0.12L,TS1SCG1.10F,TS1SCG1.10L               "
                   TS1SCG2.8F, TS1SCG2.8L, TS1SCG3.7F, TS1SCG3.7L, TS1SCG4.5F                "
                   TS1SCG4.5L, TS1SCG5.3F, TS1SCG5.3L                                        "
...
static INPUT_PORTS_START( alpiner )
	...
	PORT_BIT( 0x0080, IP_ACTIVE_HIGH, IPT_CUSTOM ) PORT_READ_LINE_MEMBER(FUNC(alpine_state::alpine_motor_r<0>)) // steps are free
	PORT_BIT( 0x0100, IP_ACTIVE_HIGH, IPT_CUSTOM ) PORT_READ_LINE_MEMBER(FUNC(alpine_state::alpine_motor_r<1>)) // steps are locked
...
static INPUT_PORTS_START( cybrcycc )
	...
	PORT_START("ADC.0")
	PORT_BIT( 0x3ff, 0x200, IPT_PADDLE ) PORT_MINMAX(0x004, 0x3fc) PORT_SENSITIVITY(100) PORT_KEYDELTA(40) PORT_NAME("Bike Bank")

	PORT_START("ADC.1")
	PORT_BIT( 0x3ff, 0x000, IPT_PEDAL )  PORT_MINMAX(0x000, 0x300) PORT_SENSITIVITY(100) PORT_KEYDELTA(40) PORT_NAME("Throttle Grip")

	PORT_START("ADC.2")
	PORT_BIT( 0x3ff, 0x000, IPT_PEDAL2 ) PORT_MINMAX(0x000, 0x100) PORT_SENSITIVITY(100) PORT_KEYDELTA(40) PORT_NAME("Brake Lever")
...
static INPUT_PORTS_START( tokyowar )
	...
	PORT_START("ADC.2")
	PORT_BIT( 0x3ff, 0x000, IPT_PEDAL )  PORT_MINMAX(0x000, 0x100) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_NAME("Forward Pedal")

	PORT_START("ADC.3")
	PORT_BIT( 0x3ff, 0x000, IPT_PEDAL2 ) PORT_MINMAX(0x000, 0x100) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_NAME("Backward Pedal")
...
ROM_START( ridgerac )
	...
	ROM_LOAD32_BYTE( "rr2_prgllb.4d", 0x00003, 0x80000, CRC(d50d4fa0) SHA1(0fcd55e653d4f596b38b4e7b876ccd1f2a3836df) ) // Ridge Racer Standard  Date 1994-01-17
	ROM_LOAD32_BYTE( "rr2_prglmb.2d", 0x00002, 0x80000, CRC(6a266f42) SHA1(470613dbddd6b3050f666de9a2b222a4b7e1e809) )
...
ROM_START( ridgeracb )
	ROM_REGION( 0x200000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "rr3_prgllb.4d", 0x00003, 0x80000, CRC(856fe5ec) SHA1(72d95b8bd5da551c3d358b8ab266373a89f8aa6a) ) // Ridge Racer Standard  -Foreign B-  Date 1994-01-17
...
ROM_START( ridgeracj )
	ROM_REGION( 0x200000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "rr1_prgll.4d", 0x00003, 0x80000, CRC(4bb7fc86) SHA1(8291375b8ec4d37e0d9e3bf38da2d5907b0f31bd) ) // Ridge Racer Standard  Date 1993-10-07
...
ROM_START( ridgeracf )
	ROM_REGION( 0x200000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "rrf2_prgll.4d", 0x00003, 0x80000, CRC(23c6144d) SHA1(99f70e2c60fba7551cafdce12b07da1f8ab8aad6) ) // Ridge Racer Full Scale  -Foreign-  Date 1993-12-13
	...
	// the texture tiles ROMs were not dumped for this version, and are not the same (bad textures if we use these roms)
	ROM_REGION( 0x1000000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "rrf1cg0.bin", 0x800000, 0x200000, BAD_DUMP CRC(b557a795) SHA1(f345486ffbe797246ad80a55d3c4a332ed6e2888) )
	ROM_LOAD( "rrf1cg1.bin", 0xa00000, 0x200000, BAD_DUMP CRC(0fa212d9) SHA1(a1311de0a504e2d399044fa8ac32ec6c56ec965f) )
	ROM_LOAD( "rrf1cg2.bin", 0xc00000, 0x200000, BAD_DUMP CRC(18e2d2bd) SHA1(69c2ea62eeb255f27d3c69373f6716b0a34683cc) )
	ROM_LOAD( "rrf1cg3.bin", 0xe00000, 0x200000, BAD_DUMP CRC(9564488b) SHA1(6b27d1aea75d6be747c62e165cfa49ecc5d9e767) )
	...
	ROM_REGION( 0x300000, "pointrom", 0 ) // 3d model data
	ROM_LOAD( "rrf2potl0.l0", 0x000000, 0x080000, CRC(9b762e60) SHA1(50b67ff6678bacba140bad3aedda75c30851fa7a) )
	ROM_LOAD( "rrf2potl1.l1", 0x080000, 0x080000, CRC(ab4d66b0) SHA1(59020b3dc2efff99cd528752ca7168b64ae96ac4) )
	ROM_LOAD( "rrf2potm0.m0", 0x100000, 0x080000, CRC(02d4daa3) SHA1(9b4e48d3234cb91146b5d31ffcf42ad199ccb903) )
	ROM_LOAD( "rrf2potm1.m1", 0x180000, 0x080000, CRC(37e005c2) SHA1(036ae1c44aaa6a6904e6d4938572035ccc6854ed) )
	ROM_LOAD( "rrf2potu0.u0", 0x200000, 0x080000, CRC(86b3fe98) SHA1(f242d33f7488e233ccdc0b5d309c64510d7a622d) )
	ROM_LOAD( "rrf2potu1.u1", 0x280000, 0x080000, CRC(e0c6ce3d) SHA1(cc559a2237ccb753cb1397fecba64733455a8c43) )

	ROM_REGION( 0x1000000, "c352", 0 ) // samples
	ROM_LOAD( "rrf1wave0.10r", 0x000000, 0x100000, CRC(a8e85bde) SHA1(b56677e9f6c98f7b600043f5dcfef3a482ca7455) )
	ROM_LOAD( "rrf1wave1.10p", 0x200000, 0x100000, CRC(35f47c8e) SHA1(7c3f9e942f532af8008fbead2a96fee6084bcde6) )
	ROM_LOAD( "rrf1wave2.10n", 0x100000, 0x100000, CRC(4ceeae12) SHA1(ae3a6583f8912bc784c7bc63d32448228cf217ba) ) // differs from normal sets
	ROM_LOAD( "rrf1wave3.10l", 0x300000, 0x100000, CRC(c4cda1a7) SHA1(60bc96880ec79efdff3cc70c09e848692a40bea4) )
...
ROM_START( ridgera2 )
	ROM_REGION( 0x200000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "rrs2_prgll.4d", 0x00003, 0x80000, CRC(88199c0f) SHA1(5cf5bb714c3d209943a8d815eaea60afd34641ff) ) // Ridge Racer 2 Standard  Date 1994-06-21  -Foreign-
	ROM_LOAD32_BYTE( "rrs2_prglm.2d", 0x00002, 0x80000, CRC(8e86f199) SHA1(7bd9ec9147ef0380864508f66203ef2c6ad1f7f6) ) // One byte different compared to the Rev.B Japanese set below
	...
	ROM_REGION( 0x1000000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "rrs1cg0.1a", 0x800000, 0x200000, CRC(714c0091) SHA1(df29512bd6e64827660c40304051366d2c4d7977) )
	ROM_LOAD( "rrs1cg1.2a", 0xa00000, 0x200000, CRC(836545c1) SHA1(05e3346463d8d42b5d33216207e855033a65510d) )
	ROM_LOAD( "rrs1cg2.3a", 0xc00000, 0x200000, CRC(00e9799d) SHA1(280184451138420f64080efe13e5e2795f7b61d4) )
	ROM_LOAD( "rrs1cg3.5a", 0xe00000, 0x200000, CRC(3858983f) SHA1(feda270b71f1310ecf4c17823bc8827ca2951b40) )
	...
	ROM_REGION( 0x300000, "pointrom", 0 ) // 3d model data
	ROM_LOAD( "rrs1pol0.5b", 0x000000, 0x080000, CRC(9376c384) SHA1(cde0e36db1beab1523607098a760d81fac2ea90e) )
	ROM_LOAD( "rrs1pol1.4b", 0x080000, 0x080000, CRC(094fa832) SHA1(cc59442540b1cdef068c4408b6e048c11042beb8) )
	ROM_LOAD( "rrs1pom0.5c", 0x100000, 0x080000, CRC(b47a7f8b) SHA1(0fa0456ad8b4864a7071b5b5ba1a78877c1ac0f0) )
	ROM_LOAD( "rrs1pom1.4c", 0x180000, 0x080000, CRC(27260361) SHA1(8775cc779eb8b6a0d79fa84d606c970ec2d6ea8d) )
	ROM_LOAD( "rrs1pou0.5d", 0x200000, 0x080000, CRC(74d6ec84) SHA1(63f5beee51443c98100330ec04291f71e10716c4) )
	ROM_LOAD( "rrs1pou1.4d", 0x280000, 0x080000, CRC(f527caaa) SHA1(f92bdd15323239d593ddac92a11d23a27e6635ed) )

	ROM_REGION( 0x1000000, "c352", 0 ) // samples
	ROM_LOAD( "rrs1wav0.10r", 0x000000, 0x100000, CRC(99d11a2d) SHA1(1f3db98a99be0f07c03b0a7817561459a58f310e) )
	ROM_LOAD( "rrs1wav1.10p", 0x200000, 0x100000, CRC(ad28444a) SHA1(c31bbf3cae5015e5494fe4988b9b01d822224c69) )
	ROM_LOAD( "rrs1wav2.10n", 0x100000, 0x100000, CRC(6f0d4619) SHA1(cd3d57f2ea21497f388ffa29ec7d2665647a01c0) )
	ROM_LOAD( "rrs1wav3.10l", 0x300000, 0x100000, CRC(106e761f) SHA1(97f47b857bdcbc79b0aface53dd385e67fcc9108) )
...
ROM_START( ridgera2j )
	ROM_REGION( 0x200000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "rrs1_prgllb.4d", 0x00003, 0x80000, CRC(22f069e5) SHA1(fcaec3aa83853c39d713ed01c511060663027ccd) ) // Ridge Racer 2 Standard  Date 1994-06-21
...
ROM_START( ridgera2ja )
	ROM_REGION( 0x200000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "rrs1_prgll.4d", 0x00003, 0x80000, CRC(fbf785a2) SHA1(b9333c7623f68f48aa6ae50913a22a527a19576a) ) // Ridge Racer 2 Standard  Date 1994-06-13
	ROM_LOAD32_BYTE( "rrs1_prglm.2d", 0x00002, 0x80000, CRC(562f747a) SHA1(79d818b87c9a992fc9706fb39e6d560c2b0aa392) )
...
ROM_START( ridgera28 )
	ROM_REGION( 0x200000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "rrs_8_prgll.4d", 0x00003, 0x80000, CRC(c8d2bc61) SHA1(9db734fc45f47e6742ef2a8ba2558efb881df94a) ) // Ridge Racer 2 Standard  Date 1994-XX-XX
...
ROM_START( raverace )
	...
	ROM_REGION( 0x1000000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "rv1cg0.1a", 0x000000, 0x200000, CRC(c518f06b) SHA1(4c01d453244192dd13087bdc72a7f7be80b47cbc) ) // == rv1cg0.2a
	ROM_LOAD( "rv1cg1.1c", 0x200000, 0x200000, CRC(6628f792) SHA1(7a5405c5fcb2f3f001ae17df393c31e61a834f2b) ) // == rv1cg1.2c
	ROM_LOAD( "rv1cg2.1d", 0x400000, 0x200000, CRC(0b707cc5) SHA1(38e1a554b278062edc369565353497ac4b016f78) ) // == rv1cg2.2d
	ROM_LOAD( "rv1cg3.1e", 0x600000, 0x200000, CRC(39b62921) SHA1(873287d81338baf10dd85214d82f6c38bfdf199e) ) // == rv1cg3.2e
	ROM_LOAD( "rv1cg4.1f", 0x800000, 0x200000, CRC(a9791ea2) SHA1(245b2ebbadd1fbca90dc241f88e9f6f341b2a01a) ) // == rv1cg4.2f
	ROM_LOAD( "rv1cg5.1j", 0xa00000, 0x200000, CRC(b2c79ec1) SHA1(6f669996863bdf1fe09b0c1a2a876625029d3d43) ) // == rv1cg5.2j
	ROM_LOAD( "rv1cg6.1k", 0xc00000, 0x200000, CRC(8cddedc2) SHA1(e3993f5505bc7e61bec7be5b48c873572e1220f7) ) // == rv1cg6.2k
	ROM_LOAD( "rv1cg7.1n", 0xe00000, 0x200000, CRC(b39147ca) SHA1(50ca6691fc809c95e6999dd52e39f2b8c2d22f3b) ) // == rv1cg7.2n
	ROM_LOAD( "rv1cg0.2a", 0x000000, 0x200000, CRC(c518f06b) SHA1(4c01d453244192dd13087bdc72a7f7be80b47cbc) )
	ROM_LOAD( "rv1cg1.2c", 0x200000, 0x200000, CRC(6628f792) SHA1(7a5405c5fcb2f3f001ae17df393c31e61a834f2b) )
	ROM_LOAD( "rv1cg2.2d", 0x400000, 0x200000, CRC(0b707cc5) SHA1(38e1a554b278062edc369565353497ac4b016f78) )
	ROM_LOAD( "rv1cg3.2e", 0x600000, 0x200000, CRC(39b62921) SHA1(873287d81338baf10dd85214d82f6c38bfdf199e) )
	ROM_LOAD( "rv1cg4.2f", 0x800000, 0x200000, CRC(a9791ea2) SHA1(245b2ebbadd1fbca90dc241f88e9f6f341b2a01a) )
	ROM_LOAD( "rv1cg5.2j", 0xa00000, 0x200000, CRC(b2c79ec1) SHA1(6f669996863bdf1fe09b0c1a2a876625029d3d43) )
	ROM_LOAD( "rv1cg6.2k", 0xc00000, 0x200000, CRC(8cddedc2) SHA1(e3993f5505bc7e61bec7be5b48c873572e1220f7) )
	ROM_LOAD( "rv1cg7.2n", 0xe00000, 0x200000, CRC(b39147ca) SHA1(50ca6691fc809c95e6999dd52e39f2b8c2d22f3b) )
	...
	ROM_LOAD( "rv1ccrl.5l",  0x000000, 0x200000, CRC(bc634f72) SHA1(b5c504ed92bca7682614fc4c51f38cff607e6f2a) )
	ROM_LOAD( "rv1ccrh.5j",  0x200000, 0x080000, CRC(a741b262) SHA1(363076220a0eacc67befda05f8253963e8ffbcaa) )

	ROM_REGION( 0x600000, "pointrom", 0 ) // 3d model data
	ROM_LOAD( "rv1potl0.5b", 0x000000, 0x080000, CRC(de2ce519) SHA1(2fe0dd000571f76d1a4df6a439d40119125170ef) )
	ROM_LOAD( "rv1potl1.4b", 0x080000, 0x080000, CRC(2215cb5a) SHA1(d48ee692ab3dbcffdc49d22f6f232ca9390da766) )
	ROM_LOAD( "rv1potl2.3b", 0x100000, 0x080000, CRC(ddb15bf7) SHA1(4c54ec98e0cba10841d43a4ce593cdacfd7f90f8) )
	ROM_LOAD( "rv1potl3.2b", 0x180000, 0x080000, CRC(fa9361ca) SHA1(35a5c2712bca9c62400b724754de3a931ad21561) )
	ROM_LOAD( "rv1potm0.5c", 0x200000, 0x080000, CRC(3c024f3a) SHA1(711f0442823797b2d410352796a5cca66af98dce) )
	ROM_LOAD( "rv1potm1.4c", 0x280000, 0x080000, CRC(b1a32a68) SHA1(e24abb3a7e35d098abae5420bf8ef5c975718987) )
	ROM_LOAD( "rv1potm2.3c", 0x300000, 0x080000, CRC(a414fe15) SHA1(eb27cdca045ab2ab27dec179043328847fb65e11) )
	ROM_LOAD( "rv1potm3.2c", 0x380000, 0x080000, CRC(2953bbb4) SHA1(aca1acd87f7130d2522d0c6f8e60beeb7ab7495a) )
	ROM_LOAD( "rv1potu0.5d", 0x400000, 0x080000, CRC(b9eaf3cc) SHA1(3b2a9041f1fa90706ecf7d4fbff918516f891a07) )
	ROM_LOAD( "rv1potu1.4d", 0x480000, 0x080000, CRC(a5c55258) SHA1(826d4dde761aec7d848456f7bc4ba6268fe99605) )
	ROM_LOAD( "rv1potu2.3d", 0x500000, 0x080000, CRC(c18fcb74) SHA1(a4009ae2b014dc89aed4741fd97f84350117c2f4) )
	ROM_LOAD( "rv1potu3.2d", 0x580000, 0x080000, CRC(79735aaa) SHA1(1cf14274669b916a7641f7a16785da1b72347485) )
...
ROM_START( raveracej )
	ROM_REGION( 0x200000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "rv1_prgllb.4d", 0x00003, 0x80000, CRC(71da3eea) SHA1(8a641bb23e0ad89cae5ee1570f8a3627b2434d20) ) // Raveracer Standard  Date: 07/16/95
	ROM_LOAD32_BYTE( "rv1_prglmb.2d", 0x00002, 0x80000, CRC(6ab7e9ce) SHA1(0c6376ca5a63409aeea344bbc201af6c47afe9ab) )
...
ROM_START( raveraceja )
	ROM_REGION( 0x200000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "rv1_prgll.4d", 0x00003, 0x80000, CRC(5dfce6cd) SHA1(1aeeca1e507ae4cbe3d39ca5efd1cc4fe1ab03a8) ) // Raveracer Standard  Date: 06/29/95
...
ROM_START( cybrcomm )
	...
	ROM_REGION( 0x1000000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "cyc1cg0.1a", 0x800000, 0x200000, CRC(e839b9bd) SHA1(fee43d37dcca7f1fb952a6bfb886b7ee30b7d75c) ) // == cyc1cg0.6a
	ROM_LOAD( "cyc1cg1.2a", 0xa00000, 0x200000, CRC(7d13993f) SHA1(96ac82bcc63afe395bae73f005eb66dad7742d48) ) // == cyc1cg1.7a
	ROM_LOAD( "cyc1cg2.3a", 0xc00000, 0x200000, CRC(7c464566) SHA1(69817ac3a7c6e43b960e8a904962b58b23417163) ) // == cyc1cg2.8a
	ROM_LOAD( "cyc1cg3.5a", 0xe00000, 0x200000, CRC(2222e16f) SHA1(562bcd4d43b1543303d8fd66d9f0d9a8e3702492) ) // == cyc1cg3.9a
	ROM_LOAD( "cyc1cg0.6a", 0x800000, 0x200000, CRC(e839b9bd) SHA1(fee43d37dcca7f1fb952a6bfb886b7ee30b7d75c) )
	ROM_LOAD( "cyc1cg1.7a", 0xa00000, 0x200000, CRC(7d13993f) SHA1(96ac82bcc63afe395bae73f005eb66dad7742d48) )
	ROM_LOAD( "cyc1cg2.8a", 0xc00000, 0x200000, CRC(7c464566) SHA1(69817ac3a7c6e43b960e8a904962b58b23417163) )
	ROM_LOAD( "cyc1cg3.9a", 0xe00000, 0x200000, CRC(2222e16f) SHA1(562bcd4d43b1543303d8fd66d9f0d9a8e3702492) )

	ROM_REGION16_LE( 0x280000, "textilemap", 0 ) // texture tilemap
	ROM_LOAD( "cyc1ccrl.1c", 0x000000, 0x100000, CRC(1a0dc5f0) SHA1(bf0093d9cbdcb45a82705e966c48a1f408fa344e) ) // == cyc1ccrl.8c - FIXED BITS xxxxxxxx11xxxxxx
	ROM_LOAD( "cyc1ccrh.2c", 0x200000, 0x080000, CRC(8c4090b8) SHA1(456d548a48833e840c5d39d47b2dcca03f8d6321) ) // == cyc1ccrh.7c - 1xxxxxxxxxxxxxxxxxx = 0xFF
	ROM_LOAD( "cyc1ccrl.8c", 0x000000, 0x100000, CRC(1a0dc5f0) SHA1(bf0093d9cbdcb45a82705e966c48a1f408fa344e) )
	ROM_LOAD( "cyc1ccrh.7c", 0x200000, 0x080000, CRC(8c4090b8) SHA1(456d548a48833e840c5d39d47b2dcca03f8d6321) )

	ROM_REGION( 0x480000, "pointrom", 0 ) // 3d model data
	ROM_LOAD( "cyc1ptl0.5b", 0x000000, 0x080000, CRC(d91de03d) SHA1(05819d285f6111867c41337bda9c4b9ad5394b6b) )
	ROM_LOAD( "cyc1ptl1.4b", 0x080000, 0x080000, CRC(e5b98021) SHA1(7416cbf74da969f822e0363ced7a25b967277e28) )
	ROM_LOAD( "cyc1ptl2.3b", 0x100000, 0x080000, CRC(7ba786c6) SHA1(1a5319dec495453bab9d70ae773a807f0036b355) )
	ROM_LOAD( "cyc1ptm0.5c", 0x180000, 0x080000, CRC(d454b5c6) SHA1(95ae6f0455e9fd7dff066e74cd4343c94d1bc212) )
	ROM_LOAD( "cyc1ptm1.4c", 0x200000, 0x080000, CRC(74fdf8cc) SHA1(f2627f400e247b6d4c4157eaf0ec69d57212e566) )
	ROM_LOAD( "cyc1ptm2.3c", 0x280000, 0x080000, CRC(b9c99a45) SHA1(c86cf594b416776eaf9a32c3cb9d34acc79777e9) )
	ROM_LOAD( "cyc1ptu0.5d", 0x300000, 0x080000, CRC(4d40897f) SHA1(ffe2a0ab66443553c83512f9a1be94b2e385cf2f) )
	ROM_LOAD( "cyc1ptu1.4d", 0x380000, 0x080000, CRC(3bdaeeeb) SHA1(826f97e2165af8569cfec03874b16030a9486559) )
...
ROM_START( acedrive )
	ROM_REGION( 0x200000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "ad2_prgll.4d", 0x00003, 0x80000, CRC(808c5ff8) SHA1(119c90ecb5aa099a0e5d1d7944c004beacead367) ) // Version 94/10/20 16:22:25
	ROM_LOAD32_BYTE( "ad2_prglm.2d", 0x00002, 0x80000, CRC(5f726a10) SHA1(d077312c6a387fbdf906d278c73c6a3730687f32) )
	...
	ROM_REGION( 0x1000000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "ad1cg0.1a", 0x800000, 0x200000, CRC(faaa1ee2) SHA1(878f2b74587ed4d06c5110a0eb0020c49ddc5dfa) )
	ROM_LOAD( "ad1cg1.2a", 0xa00000, 0x200000, CRC(1aab1eb7) SHA1(b8f9eeafec7e0de340cf48e38fa55dd14404c867) )
	ROM_LOAD( "ad1cg2.3a", 0xc00000, 0x200000, CRC(cdcd1874) SHA1(5a7a4a0d897cca4956b0a4f178f39f618c921861) )
	ROM_LOAD( "ad1cg3.5a", 0xe00000, 0x200000, CRC(effdd2cd) SHA1(9ff156e7e38c103b8fa6f3c29776dd38482d9cf2) )
	...
	ROM_REGION( 0x300000, "pointrom", 0 ) // 3d model data
	ROM_LOAD( "ad1potl0.5b", 0x000000, 0x080000, CRC(dfc7e729) SHA1(5e3deef66d0a5dd2ff0584b8c8be4bf5e798e4d0) )
	ROM_LOAD( "ad1potl1.4b", 0x080000, 0x080000, CRC(5914ef8e) SHA1(f6db9c3061ceda76eef0a9538d9c048366b71124) )
	ROM_LOAD( "ad1potm0.5c", 0x100000, 0x080000, CRC(844bcd6b) SHA1(629b8dc0a7e94410c08c8874b69d9f4bc22f3e4f) )
	ROM_LOAD( "ad1potm1.4c", 0x180000, 0x080000, CRC(515cf541) SHA1(db1522813ea3e982d479cc1903d18799bf75aea9) )
	ROM_LOAD( "ad1potu0.5d", 0x200000, 0x080000, CRC(e0f44949) SHA1(ffdb64d600883974b05edaa9ed3071af355ee17f) )
	ROM_LOAD( "ad1potu1.4d", 0x280000, 0x080000, CRC(f2cd2cbb) SHA1(19fe6e3454a1e4353c7fe0a0d7a71742fea946de) )

	ROM_REGION( 0x1000000, "c352", 0 ) // samples
	ROM_LOAD( "ad1wave0.10r", 0x000000, 0x100000, CRC(c7879a72) SHA1(ae04d664858b0944583590ed0003a9420032d5ca) )
	ROM_LOAD( "ad1wave1.10p", 0x200000, 0x100000, CRC(69c1d41e) SHA1(b5cdfe7b75075c585dfd842347f8e4e692bb2781) )
	ROM_LOAD( "ad1wave2.10n", 0x100000, 0x100000, CRC(365a6831) SHA1(ddaa44a4436d6de120b64a5d130b1ee18f872e19) )
	ROM_LOAD( "ad1wave3.10l", 0x300000, 0x100000, CRC(cd8ecb0b) SHA1(7950b5a3a81f5554f57accabc7a623b8265a21a1) )
...
ROM_START( victlap )
	ROM_REGION( 0x200000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "adv2_prgllb.4d", 0x00003, 0x80000, CRC(03ba6e42) SHA1(0e8138214463a6db59a6f7cbea3f0b6ed1b82465) ) // Version 96/05/21 19:39:59
	...
	ROM_REGION( 0x1000000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "adv1cg0.2a",  0x000000, 0x200000, CRC(13353848) SHA1(c6c7693e3cb086919daf9fcaf6bf602142213073) )
	ROM_LOAD( "adv1cg1.1c",  0x200000, 0x200000, CRC(1542066c) SHA1(20a053e919b7a81da2a17d31dc7482832a4d4ffe) )
	ROM_LOAD( "adv1cg2.2d",  0x400000, 0x200000, CRC(111f371c) SHA1(29d8062daae51b3c1712bd30baa9813a2b5b374d) )
	ROM_LOAD( "adv1cg3.1e",  0x600000, 0x200000, CRC(a077831f) SHA1(71bb95199b368e48bc474123ca84d19213f73137) )
	ROM_LOAD( "adv1cg4.2f",  0x800000, 0x200000, CRC(71abdacf) SHA1(64409e6aa40dd9e5a6dd1dc306860fbbf6ee7c3e) )
	ROM_LOAD( "adv1cg5.1j",  0xa00000, 0x200000, CRC(cd6cd798) SHA1(51070997a457c0ace078174569cd548ac2226b2d) )
	ROM_LOAD( "adv1cg6.2k",  0xc00000, 0x200000, CRC(94bdafba) SHA1(41e64fa99b342edd8b0ed95ae9869c23e03399e6) )
	ROM_LOAD( "adv1cg7.1n",  0xe00000, 0x200000, CRC(18823475) SHA1(a3244d665b59c352593de21f5cb8d55ddf8cee5c) )

	ROM_REGION16_LE( 0x280000, "textilemap", 0 ) // texture tilemap
	ROM_LOAD( "adv1ccrl.5a", 0x000000, 0x200000, CRC(dd2b96ae) SHA1(6337ce17e617234c27ebad578ba82451649aad9c) ) // == adv1ccrl.5l
	ROM_LOAD( "adv1ccrh.5c", 0x200000, 0x080000, CRC(5719844a) SHA1(a17d7bc239235e9f566931ba4fee1d6ad7964d83) ) // == adv1ccrh.5j
	ROM_LOAD( "adv1ccrl.5l", 0x000000, 0x200000, CRC(dd2b96ae) SHA1(6337ce17e617234c27ebad578ba82451649aad9c) )
	ROM_LOAD( "adv1ccrh.5j", 0x200000, 0x080000, CRC(5719844a) SHA1(a17d7bc239235e9f566931ba4fee1d6ad7964d83) )

	ROM_REGION( 0x480000, "pointrom", 0 ) // 3d model data
	ROM_LOAD( "adv1pot.l0", 0x000000, 0x080000, CRC(3b85b2a4) SHA1(84c92ed0105618d4aa5508af344b4b6cfa772567) )
	ROM_LOAD( "adv1pot.l1", 0x080000, 0x080000, CRC(601d6488) SHA1(c7932103ba6070e17deb3cc06060eed7789f938e) )
	ROM_LOAD( "adv1pot.l2", 0x100000, 0x080000, CRC(a0323a84) SHA1(deadf9a47461df7b137759d6886e676137b39fd2) )
	ROM_LOAD( "adv1pot.m0", 0x180000, 0x080000, CRC(20951aa2) SHA1(3de55bded443a5b78699cec4845470b53b22301a) )
	ROM_LOAD( "adv1pot.m1", 0x200000, 0x080000, CRC(5aed6fbf) SHA1(8cee781d8a12e00635b9a1e5cc8d82e64b17e8f1) )
	ROM_LOAD( "adv1pot.m2", 0x280000, 0x080000, CRC(00cbff92) SHA1(09a11ba064aafc921a7ca0add5898d91b773f10a) )
	ROM_LOAD( "adv1pot.u0", 0x300000, 0x080000, CRC(6b73dd2a) SHA1(e3654ab2b62e4f3314558209e37c5636f871a6c7) )
	ROM_LOAD( "adv1pot.u1", 0x380000, 0x080000, CRC(c8788f74) SHA1(606e10b05146e3db824aa608745de80584420d12) )
	ROM_LOAD( "adv1pot.u2", 0x400000, 0x080000, CRC(e67f29c5) SHA1(16222afb4f1f494711dd00ebb347c824db333bae) )
...
ROM_START( victlapj )
	ROM_REGION( 0x200000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "adv1_prgllc.4d", 0x00003, 0x80000, CRC(1c630018) SHA1(c4cddeb18c6b81c768e25489f1d5af0e9c0bbfa5) ) // Version 96/02/13 17:29:10
...
ROM_START( propcycl )
	...
	ROM_LOAD32_BYTE( "pr2vera.1", 0x00003, 0x100000, CRC(3f58594c) SHA1(5fdd8c61b47b51088a201799ce0c2f08c32ef852) )
	ROM_LOAD32_BYTE( "pr2vera.2", 0x00002, 0x100000, CRC(c0da354a) SHA1(f27a71a62385b842404fcd8ed6513158e3639b8f) )
	ROM_LOAD32_BYTE( "pr2vera.3", 0x00001, 0x100000, CRC(74bf4b74) SHA1(02713aa07238cc9e30163ae24d12c034aa972ff3) )
	ROM_LOAD32_BYTE( "pr2vera.4", 0x00000, 0x100000, CRC(cf4d5638) SHA1(2ddd00d6ec3b85c234820507650d201e176c94a2) )
	...
	ROM_REGION( 0x1000000, "sprite", ROMREGION_ERASEFF ) // 32x32x8bpp sprite tiles
	ROM_LOAD( "pr1scg0.12f",  0x000000, 0x200000, CRC(2d09a869) SHA1(ce8beabaac255e1de29d944c9866022bad713519) ) // == pr1scg0.12l
	ROM_LOAD( "pr1scg1.10f",  0x200000, 0x200000, CRC(7433c5bd) SHA1(a8fd4e73de66e3d443c0cb5b5beef8f467014815) ) // == pr1scg1.10l
	ROM_LOAD( "pr1scg0.12l",  0x000000, 0x200000, CRC(2d09a869) SHA1(ce8beabaac255e1de29d944c9866022bad713519) )
	ROM_LOAD( "pr1scg1.10l",  0x200000, 0x200000, CRC(7433c5bd) SHA1(a8fd4e73de66e3d443c0cb5b5beef8f467014815) )

	ROM_REGION( 0x1000000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "pr1cg0.8d",   0x000000, 0x200000, CRC(0a041238) SHA1(da5688970432f7fe39337ee9fb46ca25a53fdb11) ) // == pr1cg0.12b
	ROM_LOAD( "pr1cg1.10d",  0x200000, 0x200000, CRC(7d09e6a7) SHA1(892317ee0bd796fa5c70d64912ef2e696792a2d4) ) // == pr1cg1.13b
	ROM_LOAD( "pr1cg2.12d",  0x400000, 0x200000, CRC(659f006e) SHA1(23362a922cb1100950181fac4858b953d8fc0794) ) // == pr1cg2.14b
	ROM_LOAD( "pr1cg3.13d",  0x600000, 0x200000, CRC(d30bffa3) SHA1(2f05227d91d257db9fa8cae114974de602d98729) ) // == pr1cg3.16b
	ROM_LOAD( "pr1cg4.14d",  0x800000, 0x200000, CRC(f4636cc9) SHA1(4e01a476e418e5790878572e83a8a11536ce30ae) ) // == pr1cg4.18b
	ROM_LOAD( "pr1cg5.16d",  0xa00000, 0x200000, CRC(97d333de) SHA1(e8f8383f49aae834dd8b57231b25899703cef966) ) // == pr1cg5.19b
	ROM_LOAD( "pr1cg6.18d",  0xc00000, 0x200000, CRC(3e081c03) SHA1(6ccb162952f6076359b2785b5d800b39a9a3c5ce) ) // == pr1cg6.18a
	ROM_LOAD( "pr1cg7.19d",  0xe00000, 0x200000, CRC(ec9fc5c8) SHA1(16de614b26f06bbddae3ab56cebba45efd6fe81b) ) // == pr1cg7.15a
	ROM_LOAD( "pr1cg0.12b",  0x000000, 0x200000, CRC(0a041238) SHA1(da5688970432f7fe39337ee9fb46ca25a53fdb11) )
	ROM_LOAD( "pr1cg1.13b",  0x200000, 0x200000, CRC(7d09e6a7) SHA1(892317ee0bd796fa5c70d64912ef2e696792a2d4) )
	ROM_LOAD( "pr1cg2.14b",  0x400000, 0x200000, CRC(659f006e) SHA1(23362a922cb1100950181fac4858b953d8fc0794) )
	ROM_LOAD( "pr1cg3.16b",  0x600000, 0x200000, CRC(d30bffa3) SHA1(2f05227d91d257db9fa8cae114974de602d98729) )
	ROM_LOAD( "pr1cg4.18b",  0x800000, 0x200000, CRC(f4636cc9) SHA1(4e01a476e418e5790878572e83a8a11536ce30ae) )
	ROM_LOAD( "pr1cg5.19b",  0xa00000, 0x200000, CRC(97d333de) SHA1(e8f8383f49aae834dd8b57231b25899703cef966) )
	ROM_LOAD( "pr1cg6.18a",  0xc00000, 0x200000, CRC(3e081c03) SHA1(6ccb162952f6076359b2785b5d800b39a9a3c5ce) )
	ROM_LOAD( "pr1cg7.15a",  0xe00000, 0x200000, CRC(ec9fc5c8) SHA1(16de614b26f06bbddae3ab56cebba45efd6fe81b) )

	ROM_REGION16_LE( 0x280000, "textilemap", 0 ) // texture tilemap
	ROM_LOAD( "pr1ccrl.3d",  0x000000, 0x200000, CRC(e01321fd) SHA1(5938c6eff8e1b3642728c3be733f567a97cb5aad) ) // == pr1ccrl.7b
	ROM_LOAD( "pr1ccrh.1d",  0x200000, 0x080000, CRC(1d68bc31) SHA1(d534d0daebe7018e83b57cc7919c294ab89bddc8) ) // == pr1ccrh.5b
	ROM_LOAD( "pr1ccrl.7b",  0x000000, 0x200000, CRC(e01321fd) SHA1(5938c6eff8e1b3642728c3be733f567a97cb5aad) )
	ROM_LOAD( "pr1ccrh.5b",  0x200000, 0x080000, CRC(1d68bc31) SHA1(d534d0daebe7018e83b57cc7919c294ab89bddc8) )
	...
	ROM_REGION( 0x480000, "pointrom", 0 ) // 3d model data
	ROM_LOAD( "pr1ptrl0.18k", 0x000000, 0x080000, CRC(fddb27a2) SHA1(6e837b45e3f9ed7ca3d1a457d0f0124de5618d1f) )
	ROM_LOAD( "pr1ptrl1.16k", 0x080000, 0x080000, CRC(6964dd06) SHA1(f38a550165504693d20892a7dcfaf01db19b04ef) )
	ROM_LOAD( "pr1ptrl2.15k", 0x100000, 0x080000, CRC(4d7ed1d4) SHA1(8f72864a06ff8962e640cb36d062bddf5d110308) )
	ROM_LOAD( "pr1ptrm0.18j", 0x180000, 0x080000, CRC(b6f204b7) SHA1(3b34f240b399b6406faaf338ae0ab536247e64a6) )
	ROM_LOAD( "pr1ptrm1.16j", 0x200000, 0x080000, CRC(949588b7) SHA1(fdaf50ff2496200b9c981efc18b035f3c0a96ace) )
	ROM_LOAD( "pr1ptrm2.15j", 0x280000, 0x080000, CRC(dc1cef0a) SHA1(8cbc02cf73fac3cc110b676d77602ae628385eae) )
	ROM_LOAD( "pr1ptru0.18f", 0x300000, 0x080000, CRC(5d66a7c4) SHA1(c9ed1c18724192d45c1f6b40096f15d02baf2401) )
	ROM_LOAD( "pr1ptru1.16f", 0x380000, 0x080000, CRC(e9a3f72b) SHA1(f967e1adf8eee4fffdf4288d36a93c5bb4f9a126) )
	ROM_LOAD( "pr1ptru2.15f", 0x400000, 0x080000, CRC(c346a842) SHA1(299bc0a30d0e74d8adfa3dc605aebf6439f5bc18) )
...
ROM_START( propcyclj )
	ROM_REGION( 0x400000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "pr1vera.1", 0x00003, 0x100000, CRC(dfea7ff7) SHA1(9c81b145d0b6fbe14e1c5ce93ea67dacb2567220) ) // SYSTEM SUPER22 MPM(F8F) PCB stickered PR1 VER.A
	ROM_LOAD32_BYTE( "pr1vera.2", 0x00002, 0x100000, CRC(84a6f608) SHA1(c05ff3fce709bcdb7c30f019ae794979ba79970c) ) // Fujitsu MBM29F080 flash ROMs at ROM1 & ROM2 on the underside
	ROM_LOAD32_BYTE( "pr1vera.3", 0x00001, 0x100000, CRC(77f957d2) SHA1(c8a62464f427cc858d9ea33446a8648e9171ead9) ) // Fujitsu MBM29F080 flash ROMs at ROM3 & ROM4 on the upperside
	ROM_LOAD32_BYTE( "pr1vera.4", 0x00000, 0x100000, CRC(7b6844e4) SHA1(1b1c03d258c4a6d95ae227de7741f29b7d9e28d8) )
...
ROM_START( airco22b )
	...
	ROM_REGION( 0x1000000, "sprite", ROMREGION_ERASEFF ) // 32x32x8bpp sprite tiles
	ROM_LOAD( "acs1scg0.12f",  0x000000, 0x200000, CRC(e5235404) SHA1(3133b71d1bde3a9815cd02e97382b8078b62b0bb) ) // == acs1scg0.12l
	ROM_LOAD( "acs1scg1.10f",  0x200000, 0x200000, CRC(828e91e7) SHA1(8383b029cd29fbad107fd49e866defb50c11c99a) ) // == acs1scg1.10l
	ROM_LOAD( "acs1scg0.12l",  0x000000, 0x200000, CRC(e5235404) SHA1(3133b71d1bde3a9815cd02e97382b8078b62b0bb) )
	ROM_LOAD( "acs1scg1.10l",  0x200000, 0x200000, CRC(828e91e7) SHA1(8383b029cd29fbad107fd49e866defb50c11c99a) )

	ROM_REGION( 0x1000000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "acs1cg0.8d",  0x000000, 0x200000, CRC(1f31343e) SHA1(25ba730cec74e0ed0b404f5c4430b7c3368c9b52) ) // == acs1cg0.12b
	ROM_LOAD( "acs1cg1.10d", 0x200000, 0x200000, CRC(ccd5481d) SHA1(050e6fc7d4e0591f8ffc9552d140b6bd4533c06d) ) // == acs1cg1.13b
	ROM_LOAD( "acs1cg2.12d", 0x400000, 0x200000, CRC(14e5d0d2) SHA1(3147ad11098030e9cfd93fbc0a1b3aafa8b8aba6) ) // == acs1cg2.14b
	ROM_LOAD( "acs1cg3.13d", 0x600000, 0x200000, CRC(1a7bcc16) SHA1(bbc4ca5b208bea8394d1679e4e2d17d22331e2c8) ) // == acs1cg3.16b
	ROM_LOAD( "acs1cg4.14d", 0x800000, 0x200000, CRC(1920b7fb) SHA1(56318f2a96c55998bb9a8d791d56be3dfb39867e) ) // == acs1cg4.18b
	ROM_LOAD( "acs1cg5.16d", 0xa00000, 0x200000, CRC(3dd109b7) SHA1(a7f914b9b80f1bca1afb6144698578a29ca74676) ) // == acs1cg5.19b
	ROM_LOAD( "acs1cg6.18d", 0xc00000, 0x200000, CRC(ec71c8a3) SHA1(86892a91883d483ca0d422b78fa36042e02f3ad3) ) // == acs1cg6.18a
	ROM_LOAD( "acs1cg7.19d", 0xe00000, 0x200000, CRC(82271757) SHA1(023c935e78b14da310e4c29da8785b82aa3241ac) ) // == acs1cg7.15a
	ROM_LOAD( "acs1cg0.12b", 0x000000, 0x200000, CRC(1f31343e) SHA1(25ba730cec74e0ed0b404f5c4430b7c3368c9b52) )
	ROM_LOAD( "acs1cg1.13b", 0x200000, 0x200000, CRC(ccd5481d) SHA1(050e6fc7d4e0591f8ffc9552d140b6bd4533c06d) )
	ROM_LOAD( "acs1cg2.14b", 0x400000, 0x200000, CRC(14e5d0d2) SHA1(3147ad11098030e9cfd93fbc0a1b3aafa8b8aba6) )
	ROM_LOAD( "acs1cg3.16b", 0x600000, 0x200000, CRC(1a7bcc16) SHA1(bbc4ca5b208bea8394d1679e4e2d17d22331e2c8) )
	ROM_LOAD( "acs1cg4.18b", 0x800000, 0x200000, CRC(1920b7fb) SHA1(56318f2a96c55998bb9a8d791d56be3dfb39867e) )
	ROM_LOAD( "acs1cg5.19b", 0xa00000, 0x200000, CRC(3dd109b7) SHA1(a7f914b9b80f1bca1afb6144698578a29ca74676) )
	ROM_LOAD( "acs1cg6.18a", 0xc00000, 0x200000, CRC(ec71c8a3) SHA1(86892a91883d483ca0d422b78fa36042e02f3ad3) )
	ROM_LOAD( "acs1cg7.15a", 0xe00000, 0x200000, CRC(82271757) SHA1(023c935e78b14da310e4c29da8785b82aa3241ac) )

	ROM_REGION16_LE( 0x280000, "textilemap", 0 ) // texture tilemap
	ROM_LOAD( "acs1ccrl.3d",  0x000000, 0x200000, CRC(07088ba1) SHA1(a962c0821d5af28ed508cfdbd613675454e306e3) ) // == acs1ccrl.7b
	ROM_LOAD( "acs1ccrh.1d",  0x200000, 0x080000, CRC(62936af6) SHA1(ca80b68415aa2cd2ce4e90404f10640d0ae38be9) ) // == acs1ccrh.5b
	ROM_LOAD( "acs1ccrl.7b",  0x000000, 0x200000, CRC(07088ba1) SHA1(a962c0821d5af28ed508cfdbd613675454e306e3) )
	ROM_LOAD( "acs1ccrh.5b",  0x200000, 0x080000, CRC(62936af6) SHA1(ca80b68415aa2cd2ce4e90404f10640d0ae38be9) )

	ROM_REGION( 0x600000, "pointrom", 0 ) // 3d model data
	ROM_LOAD( "acs1ptl0.18k", 0x000000, 0x080000, CRC(bd5896c7) SHA1(58ec7d0f1e0bfdbf4908e1d920bbd7f094993777) )
	ROM_LOAD( "acs1ptl1.16k", 0x080000, 0x080000, CRC(e583b975) SHA1(beb0cc2b44bc69af057c2bb744cd7e1b95de577a) )
	ROM_LOAD( "acs1ptl2.15k", 0x100000, 0x080000, CRC(802d737a) SHA1(3d99a369db70d13fb87c2ff26c82b4b39afe94d9) )
	ROM_LOAD( "acs1ptl3.14k", 0x180000, 0x080000, CRC(fe556ecb) SHA1(9d9dbbb4f1d3688fb763001834640d79d9987d47) )
	ROM_LOAD( "acs1ptm0.18j", 0x200000, 0x080000, CRC(949b6c58) SHA1(6ea016551b10f5d5764921dcc5a4b81d2b93d701) )
	ROM_LOAD( "acs1ptm1.16j", 0x280000, 0x080000, CRC(8b2b99d9) SHA1(89c3545c4035509307728a9577018c1100ce3a54) )
	ROM_LOAD( "acs1ptm2.15j", 0x300000, 0x080000, CRC(f1515080) SHA1(27a87217a140477a6840a610c95ae57abc0d01a6) )
	ROM_LOAD( "acs1ptm3.14j", 0x380000, 0x080000, CRC(e364f4aa) SHA1(3af6a864765871664cccad82c4795f677be68d51) )
	ROM_LOAD( "acs1ptu0.18f", 0x400000, 0x080000, CRC(746b3084) SHA1(73397d1f22300fb3a81a0a068da4d0a8cfdc0a36) )
	ROM_LOAD( "acs1ptu1.16f", 0x480000, 0x080000, CRC(b44f1d3b) SHA1(f3f1a85c082053653e4da7d7f01f1baef1a013c8) )
	ROM_LOAD( "acs1ptu2.15f", 0x500000, 0x080000, CRC(fdd2d778) SHA1(0269f971d778e908a1efb5a63b08fb3365d98c2a) )
	ROM_LOAD( "acs1ptu3.14f", 0x580000, 0x080000, CRC(38b425d4) SHA1(8ff6dd6775d42afdff4c9fb2232e4d72b38e515a) )
...
ROM_START( cybrcycc )
	ROM_REGION( 0x400000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "cb2verc.1", 0x00003, 0x100000, CRC(a8e07a14) SHA1(9bef7068c9bf792960df922ea79e4565d7680433) )
	ROM_LOAD32_BYTE( "cb2verc.2", 0x00002, 0x100000, CRC(054c504f) SHA1(9bde803ff09be0402f9b0388e55407362a2508e3) )
	ROM_LOAD32_BYTE( "cb2verc.3", 0x00001, 0x100000, CRC(47e6306c) SHA1(39d6fc2c3cb9b4c9d3569cedb79b916a90537115) )
	ROM_LOAD32_BYTE( "cb2verc.4", 0x00000, 0x100000, CRC(398426e4) SHA1(f20cd4892420e7b978baa51c9129b362422a3895) )
	...
	ROM_REGION( 0x1000000, "sprite", ROMREGION_ERASEFF ) // 32x32x8bpp sprite tiles
	ROM_LOAD( "cb1scg0.12f",  0x000000, 0x200000, CRC(7aaca90d) SHA1(9808819db5d86d555a03bb20a2fbedf060d04f0e) ) // == cb1scg0.12l
	ROM_LOAD( "cb1scg0.12l",  0x000000, 0x200000, CRC(7aaca90d) SHA1(9808819db5d86d555a03bb20a2fbedf060d04f0e) ) // (intentionally loaded in at 0x000000)

	ROM_REGION( 0xe00000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "cb1cg0.8d",   0x000000, 0x200000, CRC(762a47a0) SHA1(8a49c700dca7afec5d8d6a38fedcd3ad4b0e6713) ) // == cb1cg0.12b
	ROM_LOAD( "cb1cg1.10d",  0x200000, 0x200000, CRC(df92c3e6) SHA1(302d7ee7e073a45e7baa948543bd30251f903a6d) ) // == cb1cg1.13b
	ROM_LOAD( "cb1cg2.12d",  0x400000, 0x200000, CRC(07bc508e) SHA1(7675694d10b50e57bb10b350559bd321df75d1ea) ) // == cb1cg2.14b
	ROM_LOAD( "cb1cg3.13d",  0x600000, 0x200000, CRC(50c86dea) SHA1(7837a1d2bd3ade470f7fbc732513dd598badd219) ) // == cb1cg3.16b
	ROM_LOAD( "cb1cg4.14d",  0x800000, 0x200000, CRC(e93b8894) SHA1(4d28b557b7ed2667e6af9f970f3e99cda785b940) ) // == cb1cg4.18b
	ROM_LOAD( "cb1cg5.16d",  0xa00000, 0x200000, CRC(9ee610a1) SHA1(ebc7892b6a66461ca6b6b912a264da1594340b2d) ) // == cb1cg5.19b
	ROM_LOAD( "cb1cg6.18d",  0xc00000, 0x200000, CRC(ddc3b5cc) SHA1(34edffee9eb6fbf4a00fce0da34d9354b1a1155f) ) // == cb1cg6.18a
	ROM_LOAD( "cb1cg0.12b",  0x000000, 0x200000, CRC(762a47a0) SHA1(8a49c700dca7afec5d8d6a38fedcd3ad4b0e6713) )
	ROM_LOAD( "cb1cg1.13b",  0x200000, 0x200000, CRC(df92c3e6) SHA1(302d7ee7e073a45e7baa948543bd30251f903a6d) )
	ROM_LOAD( "cb1cg2.14b",  0x400000, 0x200000, CRC(07bc508e) SHA1(7675694d10b50e57bb10b350559bd321df75d1ea) )
	ROM_LOAD( "cb1cg3.16b",  0x600000, 0x200000, CRC(50c86dea) SHA1(7837a1d2bd3ade470f7fbc732513dd598badd219) )
	ROM_LOAD( "cb1cg4.18b",  0x800000, 0x200000, CRC(e93b8894) SHA1(4d28b557b7ed2667e6af9f970f3e99cda785b940) )
	ROM_LOAD( "cb1cg5.19b",  0xa00000, 0x200000, CRC(9ee610a1) SHA1(ebc7892b6a66461ca6b6b912a264da1594340b2d) )
	ROM_LOAD( "cb1cg6.18a",  0xc00000, 0x200000, CRC(ddc3b5cc) SHA1(34edffee9eb6fbf4a00fce0da34d9354b1a1155f) )

	ROM_REGION16_LE( 0x280000, "textilemap", 0 ) // texture tilemap
	ROM_LOAD( "cb1ccrl.3d",  0x000000, 0x200000, CRC(2f171c48) SHA1(52b76213e37379b4a5cea7de40cf5396dc2998d8) ) // == cb1ccrl.7b
	ROM_LOAD( "cb1ccrh.1d",  0x200000, 0x080000, CRC(86124b93) SHA1(f2cfd726313cbeff162d402a15de2360377630e7) ) // == cb1ccrh.5b
	ROM_LOAD( "cb1ccrl.7b",  0x000000, 0x200000, CRC(2f171c48) SHA1(52b76213e37379b4a5cea7de40cf5396dc2998d8) )
	ROM_LOAD( "cb1ccrh.5b",  0x200000, 0x080000, CRC(86124b93) SHA1(f2cfd726313cbeff162d402a15de2360377630e7) )

	ROM_REGION( 0x600000, "pointrom", 0 ) // 3d model data
	ROM_LOAD( "cb1ptrl0.18k", 0x000000, 0x080000, CRC(f1393a03) SHA1(c9e808601eef5839e6bff630e5f83380e073c5c0) )
	ROM_LOAD( "cb1ptrl1.16k", 0x080000, 0x080000, CRC(2ad51de7) SHA1(efd102b960ca10cda70da84661acf61e4bbb9f00) )
	ROM_LOAD( "cb1ptrl2.15k", 0x100000, 0x080000, CRC(78f77c0d) SHA1(5183a8909c2ac0a3d80e707393bcbb4441d79a3c) )
	ROM_LOAD( "cb1ptrl3.14k", 0x180000, 0x080000, CRC(804bfb4a) SHA1(74b3fc3931265398e23605d3da7ca84a002da632) )
	ROM_LOAD( "cb1ptrm0.18j", 0x200000, 0x080000, CRC(f4eece49) SHA1(3f34d1ae5986f0d340563ab0fb637bfdacb8712c) )
	ROM_LOAD( "cb1ptrm1.16j", 0x280000, 0x080000, CRC(5f3cbd7d) SHA1(d00d0a96b71d6a3b98907c4ba7c702e549dd0adb) )
	ROM_LOAD( "cb1ptrm2.15j", 0x300000, 0x080000, CRC(02c7e4af) SHA1(6a541a28163b1026a824f6f8aed05d0eb0c8ae93) )
	ROM_LOAD( "cb1ptrm3.14j", 0x380000, 0x080000, CRC(ace3123b) SHA1(2b590ed967572d77b3cc6b37e341a5bdc55c762f) )
	ROM_LOAD( "cb1ptru0.18f", 0x400000, 0x080000, CRC(58d35341) SHA1(a5fe00bdcf39521f0465743664ff0dd78be5d6e8) )
	ROM_LOAD( "cb1ptru1.16f", 0x480000, 0x080000, CRC(f4d005b0) SHA1(0862ed1dd0818bfb765d97f1f9d996c321b0ec83) )
	ROM_LOAD( "cb1ptru2.15f", 0x500000, 0x080000, CRC(68ffcd50) SHA1(5ca5f71b6b079fde14d76c869d211a815bffae68) )
	ROM_LOAD( "cb1ptru3.14f", 0x580000, 0x080000, CRC(d89c1c2b) SHA1(9c25df696b2d120ce33d7774381460297740007a) )
...
ROM_START( cybrcyccj )
	ROM_REGION( 0x400000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "cb1verc.1", 0x00003, 0x100000, CRC(91166c69) SHA1(08e4d0d8226234b01b7d4fbc8ba2ade1ae409fe4) )
	ROM_LOAD32_BYTE( "cb1verc.2", 0x00002, 0x100000, CRC(b2e25e15) SHA1(095df28601dbc98b8974cd99b9329312980eacaf) )
	ROM_LOAD32_BYTE( "cb1verc.3", 0x00001, 0x100000, CRC(97fa2f39) SHA1(865e016553f733430aac70809b21a3b2914bb638) )
	ROM_LOAD32_BYTE( "cb1verc.4", 0x00000, 0x100000, CRC(529bd227) SHA1(6d7979643d015ae388a4a93b9dccc7f43f93baff) )
...
ROM_START( alpinerd )
	ROM_REGION( 0x400000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "ar2verd.1", 0x00003, 0x100000, CRC(fa3380b9) SHA1(2a46988745bd2672f8082399a68ae0d0ab3d28f2) )
	ROM_LOAD32_BYTE( "ar2verd.2", 0x00002, 0x100000, CRC(76141352) SHA1(0f7230dd9cd6f1b83d499034affc7bc2c4385ab5) )
	ROM_LOAD32_BYTE( "ar2verd.3", 0x00001, 0x100000, CRC(9beffe6a) SHA1(d8efd1e3829d32bb06537d7cecb59f8df9b6d663) )
	ROM_LOAD32_BYTE( "ar2verd.4", 0x00000, 0x100000, CRC(1f3f1134) SHA1(0afa78444d1463d214f1afd7ec500af76d567489) )

	ROM_REGION16_LE( 0x080000, "mcu", 0 ) // S22-BIOS ver1.30
	ROM_LOAD( "ar1datab.8k", 0, 0x080000, CRC(c26306f8) SHA1(6d8d993c076d5ced523143a86bd0938b3794478d) )

	ROM_REGION( 0x1000000, "sprite", ROMREGION_ERASEFF ) // 32x32x8bpp sprite tiles
	ROM_LOAD( "ar1scg0.12f",  0x000000, 0x200000, CRC(e7be830a) SHA1(60e2162eecd7401a0c26c525de2715cbfb10c1c5) ) // == ar1scg0.12l
	ROM_LOAD( "ar1scg1.10f",  0x200000, 0x200000, CRC(8f15a686) SHA1(bce2d4380c6c39aa402566ddb0f62bbe6d7bfa1d) ) // == ar1scg1.10l
	ROM_LOAD( "ar1scg0.12l",  0x000000, 0x200000, CRC(e7be830a) SHA1(60e2162eecd7401a0c26c525de2715cbfb10c1c5) )
	ROM_LOAD( "ar1scg1.10l",  0x200000, 0x200000, CRC(8f15a686) SHA1(bce2d4380c6c39aa402566ddb0f62bbe6d7bfa1d) )

	ROM_REGION( 0x1000000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "ar1cg0.8d",   0x000000, 0x200000, CRC(93f3a9d9) SHA1(7e94c81ad5ace98a2f0d00d101d464883d38c197) ) // == ar1cg0.12b
	ROM_LOAD( "ar1cg1.10d",  0x200000, 0x200000, CRC(39828c8b) SHA1(424aa67eb0b898c9cab8a4749893a9c5696ac430) ) // == ar1cg1.13b
	ROM_LOAD( "ar1cg2.12d",  0x400000, 0x200000, CRC(f7b058d1) SHA1(fffd0f01724a26dd47b1ecceecf4a139d5746f81) ) // == ar1cg2.14b
	ROM_LOAD( "ar1cg3.13d",  0x600000, 0x200000, CRC(c28a3d2a) SHA1(cdc44fdbc99274e860c834e42b4cfafb478d4d26) ) // == ar1cg3.16b
	ROM_LOAD( "ar1cg4.14d",  0x800000, 0x200000, CRC(abdb161f) SHA1(260bff9b0e94c1b2ea4b9d7fa170fbca212e85ee) ) // == ar1cg4.18b
	ROM_LOAD( "ar1cg5.16d",  0xa00000, 0x200000, CRC(2381cfea) SHA1(1de4c8b94df233fd74771fa47843290a3d8df0c8) ) // == ar1cg5.19b
	ROM_LOAD( "ar1cg6.18d",  0xc00000, 0x200000, CRC(ca0b6d23) SHA1(df969e0eeec557a95584b06995b0d55f2c6ec70a) ) // == ar1cg6.18b
	ROM_LOAD( "ar1cg7.19d",  0xe00000, 0x200000, CRC(ffb9f9f9) SHA1(2b8c75b580f77e887df7d50909a3a95cda570e20) ) // == ar1cg7.15a
	ROM_LOAD( "ar1cg0.12b",  0x000000, 0x200000, CRC(93f3a9d9) SHA1(7e94c81ad5ace98a2f0d00d101d464883d38c197) )
	ROM_LOAD( "ar1cg1.13b",  0x200000, 0x200000, CRC(39828c8b) SHA1(424aa67eb0b898c9cab8a4749893a9c5696ac430) )
	ROM_LOAD( "ar1cg2.14b",  0x400000, 0x200000, CRC(f7b058d1) SHA1(fffd0f01724a26dd47b1ecceecf4a139d5746f81) )
	ROM_LOAD( "ar1cg3.16b",  0x600000, 0x200000, CRC(c28a3d2a) SHA1(cdc44fdbc99274e860c834e42b4cfafb478d4d26) )
	ROM_LOAD( "ar1cg4.18b",  0x800000, 0x200000, CRC(abdb161f) SHA1(260bff9b0e94c1b2ea4b9d7fa170fbca212e85ee) )
	ROM_LOAD( "ar1cg5.19b",  0xa00000, 0x200000, CRC(2381cfea) SHA1(1de4c8b94df233fd74771fa47843290a3d8df0c8) )
	ROM_LOAD( "ar1cg6.18b",  0xc00000, 0x200000, CRC(ca0b6d23) SHA1(df969e0eeec557a95584b06995b0d55f2c6ec70a) )
	ROM_LOAD( "ar1cg7.15a",  0xe00000, 0x200000, CRC(ffb9f9f9) SHA1(2b8c75b580f77e887df7d50909a3a95cda570e20) )

	ROM_REGION16_LE( 0x280000, "textilemap", 0 ) // texture tilemap
	ROM_LOAD( "ar1ccrl.3d",  0x000000, 0x200000, CRC(17387b2c) SHA1(dfd7cadaf97917347c0fa98f395364a543e49612) ) // == ar1ccrl.7b
	ROM_LOAD( "ar1ccrh.1d",  0x200000, 0x080000, CRC(ee7a4803) SHA1(8383c9a8ef5ed94df13446ca5cefa5f9e518f175) ) // == ar1ccrh.5b
	ROM_LOAD( "ar1ccrl.7b",  0x000000, 0x200000, CRC(17387b2c) SHA1(dfd7cadaf97917347c0fa98f395364a543e49612) )
	ROM_LOAD( "ar1ccrh.5b",  0x200000, 0x080000, CRC(ee7a4803) SHA1(8383c9a8ef5ed94df13446ca5cefa5f9e518f175) )

	ROM_REGION( 0x600000, "pointrom", 0 ) // 3d model data
	ROM_LOAD( "ar1ptrl0.18k", 0x000000, 0x080000, CRC(82405108) SHA1(0a40882a9bc8621c620bede404c78f6b1333f223) )
	ROM_LOAD( "ar1ptrl1.16k", 0x080000, 0x080000, CRC(8739b09c) SHA1(cd603c4dc2f9ffc4185f891eb83e4c383c564294) )
	ROM_LOAD( "ar1ptrl2.15k", 0x100000, 0x080000, CRC(bda693a9) SHA1(fe71dd3c63198737aa2d39527f0004e977e3be20) )
	ROM_LOAD( "ar1ptrl3.14k", 0x180000, 0x080000, CRC(82797405) SHA1(2f205fee2d33e183c80a906fb38900167c011240) )
	ROM_LOAD( "ar1ptrm0.18j", 0x200000, 0x080000, CRC(64bd6620) SHA1(2e33ff22208805ece304128be8887646fc890f6d) )
	ROM_LOAD( "ar1ptrm1.16j", 0x280000, 0x080000, CRC(2232f0a5) SHA1(3fccf6d4a0c4100cc85e3051024d659c4a1c769e) )
	ROM_LOAD( "ar1ptrm2.15j", 0x300000, 0x080000, CRC(8ee14e6f) SHA1(f6f1cbb748b109b365255378c18e710ba6270c1c) )
	ROM_LOAD( "ar1ptrm3.14j", 0x380000, 0x080000, CRC(1094a970) SHA1(d41b10f48e1ef312bcaf09f27fabc7252c30e648) )
	ROM_LOAD( "ar1ptru0.18f", 0x400000, 0x080000, CRC(26d88467) SHA1(d528f989fab4dd5ac1aec9b596a05fbadcc0587a) )
	ROM_LOAD( "ar1ptru1.16f", 0x480000, 0x080000, CRC(c5e2c208) SHA1(152fde0b95a5df8c781e4a83577cfbbc7672ae0d) )
	ROM_LOAD( "ar1ptru2.15f", 0x500000, 0x080000, CRC(1321ec59) SHA1(dbd3687a4c6b1aa0b18e336f99dabb9010d36639) )
	ROM_LOAD( "ar1ptru3.14f", 0x580000, 0x080000, CRC(139d7dc1) SHA1(6d25e6ad552a91a0c5fc03db7e1a801ccf9c9556) )
...
ROM_START( alpinerc )
	ROM_REGION( 0x400000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "ar2verc.1", 0x00003, 0x100000, CRC(61323842) SHA1(e3c33248340bee252f230124fa9b7fa935a60565) )
	ROM_LOAD32_BYTE( "ar2verc.2", 0x00002, 0x100000, CRC(43795b2d) SHA1(e060f3259661279a36300431c5ca7347bde8b6ec) )
	ROM_LOAD32_BYTE( "ar2verc.3", 0x00001, 0x100000, CRC(acb3003b) SHA1(ea0cbf3a1607b06b108df051f38fec1f214f42d2) )
	ROM_LOAD32_BYTE( "ar2verc.4", 0x00000, 0x100000, CRC(800acc21) SHA1(41d26766da2db46954a2351bbc50aea94bc1d564) )
...
ROM_START( alpinerjc )
	ROM_REGION( 0x400000, "maincpu", 0 ) // main program
	ROM_LOAD32_WORD_SWAP( "ar1verc.1", 0x00002, 0x200000, CRC(8a87dc27) SHA1(ea3675667dce4c184da61dbb204e39da7ae93e82) ) // SYSTEM SUPER22 MPM(F16) PCB stickered AR1 VER.C
	ROM_LOAD32_WORD_SWAP( "ar1verc.2", 0x00000, 0x200000, CRC(5f4f5615) SHA1(ff8f818a4017ee8546037a10522f2cf1de6dc7cd) ) // intel E28F016SA flash ROMs at ROM1 & ROM2
...
ROM_START( alpinr2b )
	...
	ROM_LOAD32_BYTE( "ars2verb.2", 0x000003, 0x200000, CRC(ed977f83) SHA1(26c57cdfc15f799a999ee22f141e1c0cabfc91dc) ) // 2nd half empty
	ROM_LOAD32_BYTE( "ars2verb.3", 0x000001, 0x200000, CRC(8e7a9983) SHA1(34c82e5f080efe04d6b77a77a8391cb48b69c1af) ) // "
	ROM_LOAD32_BYTE( "ars2verb.4", 0x000002, 0x200000, CRC(610e49c2) SHA1(433c6d2216551bac31584306f748af1c912c3b07) ) // "
	ROM_LOAD32_BYTE( "ars2verb.5", 0x000000, 0x200000, CRC(7f3517b0) SHA1(3e6ba1a51bf235f40f933aae1f00638b88bba522) ) // "

	ROM_REGION16_LE( 0x080000, "mcu", 0 ) // S22-BIOS ver1.30
	ROM_LOAD( "ars2data.8k",  0x000000, 0x080000, CRC(29b36dcb) SHA1(70fde130c11789c822829493a70ecefb077c0c15) )

	ROM_REGION( 0x1000000, "sprite", ROMREGION_ERASEFF ) // 32x32x8bpp sprite tiles
	ROM_LOAD( "ars1scg0.12f", 0x000000, 0x200000, CRC(bc49ed86) SHA1(289b39f2cb21c723dbe4ddd64ee4b2c5fa65c368) ) // == ars1scg0.12l
	ROM_LOAD( "ars1scg0.12l", 0x000000, 0x200000, CRC(bc49ed86) SHA1(289b39f2cb21c723dbe4ddd64ee4b2c5fa65c368) ) // (intentionally loaded in at 0x000000)

	ROM_REGION( 0xc00000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "ars1cg0.8d",   0x000000, 0x200000, CRC(74f4515c) SHA1(1e3a96281d543213d10c962b4d387c414d76e0c3) ) // == ars1cg0.12b
	ROM_LOAD( "ars1cg1.10d",  0x200000, 0x200000, CRC(329a95c1) SHA1(2cad7fd9e5ca7c64729ca2548ef4f873a0b8de64) ) // == ars1cg1.13b
	ROM_LOAD( "ars1cg2.12d",  0x400000, 0x200000, CRC(5648345a) SHA1(0dc7aedba65b7d97687a9e38a63597f16cee6179) ) // == ars1cg2.14b
	ROM_LOAD( "ars1cg3.13d",  0x600000, 0x200000, CRC(a752f205) SHA1(373b5a69e4488bc30763568ceae512ab7039f5f8) ) // == ars1cg3.16b
	ROM_LOAD( "ars1cg4.14d",  0x800000, 0x200000, CRC(54bf35b6) SHA1(aec43b66e7597ad7d113ae785417bf26164c1bca) ) // == ars1cg4.18b
	ROM_LOAD( "ars1cg5.16d",  0xa00000, 0x200000, CRC(e24a19a2) SHA1(34c1b51eea954ae3000602e550eb1cef0a10e651) ) // == ars1cg5.19b
	ROM_LOAD( "ars1cg0.12b",  0x000000, 0x200000, CRC(74f4515c) SHA1(1e3a96281d543213d10c962b4d387c414d76e0c3) )
	ROM_LOAD( "ars1cg1.13b",  0x200000, 0x200000, CRC(329a95c1) SHA1(2cad7fd9e5ca7c64729ca2548ef4f873a0b8de64) )
	ROM_LOAD( "ars1cg2.14b",  0x400000, 0x200000, CRC(5648345a) SHA1(0dc7aedba65b7d97687a9e38a63597f16cee6179) )
	ROM_LOAD( "ars1cg3.16b",  0x600000, 0x200000, CRC(a752f205) SHA1(373b5a69e4488bc30763568ceae512ab7039f5f8) )
	ROM_LOAD( "ars1cg4.18b",  0x800000, 0x200000, CRC(54bf35b6) SHA1(aec43b66e7597ad7d113ae785417bf26164c1bca) )
	ROM_LOAD( "ars1cg5.19b",  0xa00000, 0x200000, CRC(e24a19a2) SHA1(34c1b51eea954ae3000602e550eb1cef0a10e651) )

	ROM_REGION16_LE( 0x280000, "textilemap", 0 ) // texture tilemap
	ROM_LOAD( "ars1ccrl.3d",  0x000000, 0x200000, CRC(fc8c9161) SHA1(ad0fcfae27e02d68a6f8d1d03c514dc2f12d9ee8) ) // == ars1ccrl.7b
	ROM_LOAD( "ars1ccrh.1d",  0x200000, 0x080000, CRC(a17660bb) SHA1(bae2c3f20772c6cea99f271ee3f39b1f999038c6) ) // == ars1ccrh.5b
	ROM_LOAD( "ars1ccrl.7b",  0x000000, 0x200000, CRC(fc8c9161) SHA1(ad0fcfae27e02d68a6f8d1d03c514dc2f12d9ee8) )
	ROM_LOAD( "ars1ccrh.5b",  0x200000, 0x080000, CRC(a17660bb) SHA1(bae2c3f20772c6cea99f271ee3f39b1f999038c6) )
...
ROM_START( alpinr2a )
	ROM_REGION( 0x800000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "ars2vera.2", 0x000003, 0x200000, CRC(b07b15a4) SHA1(ea3b2d7b4ef4ccf3aafeef7e7eac92e8d446f4e7) ) // 2nd half empty
	ROM_LOAD32_BYTE( "ars2vera.3", 0x000002, 0x200000, CRC(90a92e40) SHA1(bf8083256e56e7e33e61b4cdaf9fd03dabfb36ba) ) // "
	ROM_LOAD32_BYTE( "ars2vera.4", 0x000001, 0x200000, CRC(9e9d771d) SHA1(6fb983e3f4f8233544667b1bbf87864e4fb8698c) ) // "
	ROM_LOAD32_BYTE( "ars2vera.5", 0x000000, 0x200000, CRC(e93c7771) SHA1(305f35488a55be1b845702df972bba8334c0726c) ) // "
...
ROM_START( alpines )
	...
	ROM_REGION( 0x1000000, "sprite", ROMREGION_ERASEFF ) // 32x32x8bpp sprite tiles
	ROM_LOAD( "af1scg0b.12f", 0x000000, 0x200000, CRC(46a6222a) SHA1(5322ef60690625b9b8dbe1cfe0c49dcd9c8b1a4c) ) // == af1scg0b.12l
	ROM_LOAD( "af1scg0b.12l", 0x000000, 0x200000, CRC(46a6222a) SHA1(5322ef60690625b9b8dbe1cfe0c49dcd9c8b1a4c) ) // (intentionally loaded in at 0x000000)

	ROM_REGION( 0xa00000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "af1cg0.8d",  0x000000, 0x200000, CRC(7423f3ff) SHA1(6a2fd44823ef46111deb57d328b1b75cc355d413) ) // == af1cg0.12b
	ROM_LOAD( "af1cg1.10d", 0x200000, 0x200000, CRC(ea76689a) SHA1(73dd3af737a3e9903abe5ed9c9ae7eded51d8350) ) // == af1cg1.13b
	ROM_LOAD( "af1cg2.12d", 0x400000, 0x200000, CRC(2a38943a) SHA1(15d737996f49bf6374ef6191bbfbe0298d398378) ) // == af1cg2.14b
	ROM_LOAD( "af1cg3.13d", 0x600000, 0x200000, CRC(7f5a3e0f) SHA1(241f9995323b28df23d20a75e1f43ce6e05434cd) ) // == af1cg3.16b
	ROM_LOAD( "af1cg4.14d", 0x800000, 0x200000, CRC(a5ee13e2) SHA1(48fd3c912690f21cbbc2a39bed0a82be41a0d011) ) // == af1cg4.18b
	ROM_LOAD( "af1cg0.12b", 0x000000, 0x200000, CRC(7423f3ff) SHA1(6a2fd44823ef46111deb57d328b1b75cc355d413) )
	ROM_LOAD( "af1cg1.13b", 0x200000, 0x200000, CRC(ea76689a) SHA1(73dd3af737a3e9903abe5ed9c9ae7eded51d8350) )
	ROM_LOAD( "af1cg2.14b", 0x400000, 0x200000, CRC(2a38943a) SHA1(15d737996f49bf6374ef6191bbfbe0298d398378) )
	ROM_LOAD( "af1cg3.16b", 0x600000, 0x200000, CRC(7f5a3e0f) SHA1(241f9995323b28df23d20a75e1f43ce6e05434cd) )
	ROM_LOAD( "af1cg4.18b", 0x800000, 0x200000, CRC(a5ee13e2) SHA1(48fd3c912690f21cbbc2a39bed0a82be41a0d011) )

	ROM_REGION16_LE( 0x280000, "textilemap", 0 ) // texture tilemap
	ROM_LOAD( "af1ccrl.3d", 0x000000, 0x200000, CRC(6c054698) SHA1(8537607646b183883c5aa4060fb0af640da4af87) ) // == af1ccrl.7b
	ROM_LOAD( "af1ccrh.1d", 0x200000, 0x080000, CRC(95a02a27) SHA1(32ee87b76ae9fcec6d825e3cf4d5cbb97db39544) ) // == af1ccrh.5b
	ROM_LOAD( "af1ccrl.7b", 0x000000, 0x200000, CRC(6c054698) SHA1(8537607646b183883c5aa4060fb0af640da4af87) )
	ROM_LOAD( "af1ccrh.5b", 0x200000, 0x080000, CRC(95a02a27) SHA1(32ee87b76ae9fcec6d825e3cf4d5cbb97db39544) )
...
ROM_START( timecris )
	ROM_REGION( 0x400000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "ts2verb.1", 0x00003, 0x100000, CRC(29b377f7) SHA1(21864ba964602115c1268fd5edd8006a13a86cfc) )
	ROM_LOAD32_BYTE( "ts2verb.2", 0x00002, 0x100000, CRC(79512e25) SHA1(137a215ec192e76e93511456ad504481a566c9c9) )
	ROM_LOAD32_BYTE( "ts2verb.3", 0x00001, 0x100000, CRC(9f4ced33) SHA1(32768b5ff263a9e3d11b7b36f6b2d7e951e07419) )
	ROM_LOAD32_BYTE( "ts2verb.4", 0x00000, 0x100000, CRC(3e0cfb38) SHA1(3c56342bd73b1617ea579a0d53e19d59bb04fd99) )

	ROM_REGION16_LE( 0x080000, "mcu", 0 ) // S22-BIOS ver1.30
	ROM_LOAD( "ts1data.8k", 0, 0x080000, CRC(e68aa973) SHA1(663e80d249be5d5841139d98a9d72e2396851272) )

	ROM_REGION( 0x1000000, "sprite", ROMREGION_ERASEFF ) // 32x32x8bpp sprite tiles
	ROM_LOAD( "ts1scg0.12f", 0x000000, 0x200000, CRC(14a3674d) SHA1(c5792a385572452b43bbc7eb8428335b19daa3c0) ) // == ts1scg0.12l
	ROM_LOAD( "ts1scg1.10f", 0x200000, 0x200000, CRC(11791dbf) SHA1(3d75b468d69a8bf398d45f310cdb8bc88b63f25c) ) // == ts1scg1.10l
	ROM_LOAD( "ts1scg2.8f",  0x400000, 0x200000, CRC(d630fff9) SHA1(691394027b858702f06282f965f5b53e6fed496b) ) // == ts1scg2.8l
	ROM_LOAD( "ts1scg3.7f",  0x600000, 0x200000, CRC(1a62f015) SHA1(7d09ae480ae7813391616ae0090929ba845a345a) ) // == ts1scg3.7l
	ROM_LOAD( "ts1scg4.5f",  0x800000, 0x200000, CRC(511b8dd6) SHA1(936649c0a61d29f024a28e4ab64cce4b55d58f64) ) // == ts1scg4.5l
	ROM_LOAD( "ts1scg5.3f",  0xa00000, 0x200000, CRC(553bb246) SHA1(94659bee4fd0afe834a8bf3414d8825411cf9e86) ) // == ts1scg5.3l
	ROM_LOAD( "ts1scg0.12l", 0x000000, 0x200000, CRC(14a3674d) SHA1(c5792a385572452b43bbc7eb8428335b19daa3c0) )
	ROM_LOAD( "ts1scg1.10l", 0x200000, 0x200000, CRC(11791dbf) SHA1(3d75b468d69a8bf398d45f310cdb8bc88b63f25c) )
	ROM_LOAD( "ts1scg2.8l",  0x400000, 0x200000, CRC(d630fff9) SHA1(691394027b858702f06282f965f5b53e6fed496b) )
	ROM_LOAD( "ts1scg3.7l",  0x600000, 0x200000, CRC(1a62f015) SHA1(7d09ae480ae7813391616ae0090929ba845a345a) )
	ROM_LOAD( "ts1scg4.5l",  0x800000, 0x200000, CRC(511b8dd6) SHA1(936649c0a61d29f024a28e4ab64cce4b55d58f64) )
	ROM_LOAD( "ts1scg5.3l",  0xa00000, 0x200000, CRC(553bb246) SHA1(94659bee4fd0afe834a8bf3414d8825411cf9e86) )

	ROM_REGION( 0x1000000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "ts1cg0.8d",   0x000000, 0x200000, CRC(de07b22c) SHA1(f4d07b8840ec8be625eff634bce619e960c334a5) ) // == ts1cg0.12b
	ROM_LOAD( "ts1cg1.10d",  0x200000, 0x200000, CRC(992d26f6) SHA1(a0b9007312804b413d4c1748527378da4d8d53b3) ) // == ts1cg1.13b
	ROM_LOAD( "ts1cg2.12d",  0x400000, 0x200000, CRC(6273954f) SHA1(d73a43888b53e4c42fc33e8e1b38e60fd3329413) ) // == ts1cg2.14b
	ROM_LOAD( "ts1cg3.13d",  0x600000, 0x200000, CRC(38171f24) SHA1(d04caaa5b1b377ced38501b014e4cb7fc831c41d) ) // == ts1cg3.16b
	ROM_LOAD( "ts1cg4.14d",  0x800000, 0x200000, CRC(51f09856) SHA1(0eef421907ee813d5117e62cf0005bf00eb29c88) ) // == ts1cg4.18b
	ROM_LOAD( "ts1cg5.16d",  0xa00000, 0x200000, CRC(4cd9fd79) SHA1(0d2018ec914683a75bdec8655d678fd562eb6d15) ) // == ts1cg5.19b
	ROM_LOAD( "ts1cg6.18d",  0xc00000, 0x200000, CRC(f17f2ec9) SHA1(ed88ec524626e5bbe2e1ea6838412d3ac85671dd) ) // == ts1cg6.18a
	ROM_LOAD( "ts1cg0.12b",  0x000000, 0x200000, CRC(de07b22c) SHA1(f4d07b8840ec8be625eff634bce619e960c334a5) )
	ROM_LOAD( "ts1cg1.13b",  0x200000, 0x200000, CRC(992d26f6) SHA1(a0b9007312804b413d4c1748527378da4d8d53b3) )
	ROM_LOAD( "ts1cg2.14b",  0x400000, 0x200000, CRC(6273954f) SHA1(d73a43888b53e4c42fc33e8e1b38e60fd3329413) )
	ROM_LOAD( "ts1cg3.16b",  0x600000, 0x200000, CRC(38171f24) SHA1(d04caaa5b1b377ced38501b014e4cb7fc831c41d) )
	ROM_LOAD( "ts1cg4.18b",  0x800000, 0x200000, CRC(51f09856) SHA1(0eef421907ee813d5117e62cf0005bf00eb29c88) )
	ROM_LOAD( "ts1cg5.19b",  0xa00000, 0x200000, CRC(4cd9fd79) SHA1(0d2018ec914683a75bdec8655d678fd562eb6d15) )
	ROM_LOAD( "ts1cg6.18a",  0xc00000, 0x200000, CRC(f17f2ec9) SHA1(ed88ec524626e5bbe2e1ea6838412d3ac85671dd) )

	ROM_REGION16_LE( 0x280000, "textilemap", 0 ) // texture tilemap
	ROM_LOAD( "ts1ccrl.3d",  0x000000, 0x200000, CRC(56cad2df) SHA1(49c0e57d5cf5d5fc4c75da6969bec01d6d443259) ) // == ts1ccrl.7b
	ROM_LOAD( "ts1ccrh.1d",  0x200000, 0x080000, CRC(a1cc3741) SHA1(7fe57924c42e287b134e5d7ad00cffdff1f18084) ) // == ts1ccrh.5b
	ROM_LOAD( "ts1ccrl.7b",  0x000000, 0x200000, CRC(56cad2df) SHA1(49c0e57d5cf5d5fc4c75da6969bec01d6d443259) )
	ROM_LOAD( "ts1ccrh.5b",  0x200000, 0x080000, CRC(a1cc3741) SHA1(7fe57924c42e287b134e5d7ad00cffdff1f18084) )

	ROM_REGION( 0x480000, "pointrom", 0 ) // 3d model data
	ROM_LOAD( "ts1ptrl0.18k", 0x000000, 0x080000, CRC(e5f2d275) SHA1(2f5057e65ec8a3ec03f841f15f10769ae1f69139) )
	ROM_LOAD( "ts1ptrl1.16k", 0x080000, 0x080000, CRC(2bba3800) SHA1(1d9c944cb06417cb0ac47a58b922dddb83387586) )
	ROM_LOAD( "ts1ptrl2.15k", 0x100000, 0x080000, CRC(d4441c08) SHA1(6a6bb9cecbf35cb81b7681e220fc33df9a01d07f) )
	ROM_LOAD( "ts1ptrm0.18j", 0x180000, 0x080000, CRC(8aea02ba) SHA1(44ba85ba6d59758448d17ec39dfb628882ddc684) )
	ROM_LOAD( "ts1ptrm1.16j", 0x200000, 0x080000, CRC(bccf19bc) SHA1(4a6566948bdd2b0f82b7c30e57d3fe65005c26e3) )
	ROM_LOAD( "ts1ptrm2.15j", 0x280000, 0x080000, CRC(7280be31) SHA1(476b7171ae855d8bbd968ccbaa55b5100d274e3b) )
	ROM_LOAD( "ts1ptru0.18f", 0x300000, 0x080000, CRC(c30d6332) SHA1(a5c59d0abfe38de975fa0d606ed8500eb02008b7) )
	ROM_LOAD( "ts1ptru1.16f", 0x380000, 0x080000, CRC(993cde84) SHA1(c9cdcca1d60bcc41ad881c02dda9895563963ead) )
	ROM_LOAD( "ts1ptru2.15f", 0x400000, 0x080000, CRC(7cb25c73) SHA1(616eab3ac238864a584394f7ec8736ece227974a) )
...
ROM_START( timecrisa )
	ROM_REGION( 0x400000, "maincpu", 0 ) // main program
	ROM_LOAD32_WORD_SWAP( "ts2vera.1", 0x00002, 0x200000, CRC(d57eb74b) SHA1(536dd9305d0ac44110c575776333310cc57b5242) )
	ROM_LOAD32_WORD_SWAP( "ts2vera.2", 0x00000, 0x200000, CRC(671588af) SHA1(63f992c6795521fd263a0ebf230f8dc88cbfc443) )
...
ROM_START( timecrisj )
	ROM_REGION( 0x400000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "ts1verb.1", 0x00003, 0x100000, CRC(17c7ba64) SHA1(bb915000dba1a259953e0cd62143e95407f57499) )
	ROM_LOAD32_BYTE( "ts1verb.2", 0x00002, 0x100000, CRC(77bacf13) SHA1(8d0bab13858e8ea813daeb99f2a9bb6946ac5888) )
	ROM_LOAD32_BYTE( "ts1verb.3", 0x00001, 0x100000, CRC(b68e62f3) SHA1(5cd0543ceeaf4399994efbfc377ff65e4e7baca8) )
	ROM_LOAD32_BYTE( "ts1verb.4", 0x00000, 0x100000, CRC(8ea2331f) SHA1(36fc49b617775b7d8d2867d6ff215962d1b96571) )
...
ROM_START( tokyowar )
	ROM_REGION( 0x400000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "tw2vera.1", 0x000003, 0x100000, CRC(2b17ca92) SHA1(7bcb1658059c59fb1a0131a41ede7157855130a8) )
	ROM_LOAD32_BYTE( "tw2vera.2", 0x000002, 0x100000, CRC(12da84e3) SHA1(a9406d0b77f60ba930c30e60bf4b3656c8905585) )
	ROM_LOAD32_BYTE( "tw2vera.3", 0x000001, 0x100000, CRC(7d42c516) SHA1(28c1596dd55c15207bbb41a8b9a5abc97abc2bc8) )
	ROM_LOAD32_BYTE( "tw2vera.4", 0x000000, 0x100000, CRC(b904ed16) SHA1(773e11536e1b3fe4971608a63a8e6eca702f8667) )

	ROM_REGION16_LE( 0x080000, "mcu", 0 ) // S22-BIOS ver1.41
	ROM_LOAD( "tw1data.8k",  0x000000, 0x080000, CRC(bd046e4b) SHA1(162bc4ab69959ccab49fd69de291d34d472fb1c8) )

	ROM_REGION( 0x1000000, "sprite", ROMREGION_ERASEFF ) // 32x32x8bpp sprite tiles
	ROM_LOAD( "tw1scg0.12f", 0x000000, 0x200000, CRC(e3ec4daa) SHA1(f3a71ae9820d62075b814ffa2fecf3343ae09ffe) ) // == tw1scg0.12l
	ROM_LOAD( "tw1scg1.10f", 0x200000, 0x200000, CRC(b18a06e9) SHA1(ecf6a1e11603b8ea5119a036a57595dea021d778) ) // == tw1scg1.10l
	ROM_LOAD( "tw1scg2.8f",  0x400000, 0x200000, CRC(36f8c3d8) SHA1(d5c965d5cdd258c77b9db3137ce33404a5a3641c) ) // == tw1scg2.8l
	ROM_LOAD( "tw1scg3.7f",  0x600000, 0x200000, CRC(8e14d013) SHA1(ca63105a5c07bb9653499eef7a757db52612b59b) ) // == tw1scg3.7l
	ROM_LOAD( "tw1scg0.12l", 0x000000, 0x200000, CRC(e3ec4daa) SHA1(f3a71ae9820d62075b814ffa2fecf3343ae09ffe) )
	ROM_LOAD( "tw1scg1.10l", 0x200000, 0x200000, CRC(b18a06e9) SHA1(ecf6a1e11603b8ea5119a036a57595dea021d778) )
	ROM_LOAD( "tw1scg2.8l",  0x400000, 0x200000, CRC(36f8c3d8) SHA1(d5c965d5cdd258c77b9db3137ce33404a5a3641c) )
	ROM_LOAD( "tw1scg3.7l",  0x600000, 0x200000, CRC(8e14d013) SHA1(ca63105a5c07bb9653499eef7a757db52612b59b) )

	ROM_REGION( 0x1000000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "tw1cg0.8d",  0x000000, 0x200000, CRC(98b9b070) SHA1(cb920a34700dab330c967cc634717134c04b7e1d) ) // == tw1cg0.12b
	ROM_LOAD( "tw1cg1.10d", 0x200000, 0x200000, CRC(f96a723a) SHA1(5ba14963a4c51c875ac8d3b42049bc334de90038) ) // == tw1cg1.13b
	ROM_LOAD( "tw1cg2.12d", 0x400000, 0x200000, CRC(573e9ded) SHA1(815bda1ac000532c915c2d65ffdb04fee6fa8201) ) // == tw1cg2.14b
	ROM_LOAD( "tw1cg3.13d", 0x600000, 0x200000, CRC(302d5c74) SHA1(5a823f6842cf0f79eb93da47d5bf8c5f51e420db) ) // == tw1cg3.16b
	ROM_LOAD( "tw1cg4.14d", 0x800000, 0x200000, CRC(ab8aa1df) SHA1(355192d999f493e0761fbc822fa9b30c33d8e1c4) ) // == tw1cg4.18b
	ROM_LOAD( "tw1cg5.16d", 0xa00000, 0x200000, CRC(5063f3d0) SHA1(ad8dd2f4184373a3a3ca748b411a5eec1835dc97) ) // == tw1cg5.19b
	ROM_LOAD( "tw1cg6.18d", 0xc00000, 0x200000, CRC(d764027c) SHA1(5cbf93392683885c220628936ba50c09cb40fcfb) ) // == tw1cg6.18a
	ROM_LOAD( "tw1cg7.19d", 0xe00000, 0x200000, CRC(12da0a43) SHA1(99287348a5219146bcd3e61fde3f2bc26b0c5a25) ) // == tw1cg7.15a
	ROM_LOAD( "tw1cg0.12b", 0x000000, 0x200000, CRC(98b9b070) SHA1(cb920a34700dab330c967cc634717134c04b7e1d) )
	ROM_LOAD( "tw1cg1.13b", 0x200000, 0x200000, CRC(f96a723a) SHA1(5ba14963a4c51c875ac8d3b42049bc334de90038) )
	ROM_LOAD( "tw1cg2.14b", 0x400000, 0x200000, CRC(573e9ded) SHA1(815bda1ac000532c915c2d65ffdb04fee6fa8201) )
	ROM_LOAD( "tw1cg3.16b", 0x600000, 0x200000, CRC(302d5c74) SHA1(5a823f6842cf0f79eb93da47d5bf8c5f51e420db) )
	ROM_LOAD( "tw1cg4.18b", 0x800000, 0x200000, CRC(ab8aa1df) SHA1(355192d999f493e0761fbc822fa9b30c33d8e1c4) )
	ROM_LOAD( "tw1cg5.19b", 0xa00000, 0x200000, CRC(5063f3d0) SHA1(ad8dd2f4184373a3a3ca748b411a5eec1835dc97) )
	ROM_LOAD( "tw1cg6.18a", 0xc00000, 0x200000, CRC(d764027c) SHA1(5cbf93392683885c220628936ba50c09cb40fcfb) )
	ROM_LOAD( "tw1cg7.15a", 0xe00000, 0x200000, CRC(12da0a43) SHA1(99287348a5219146bcd3e61fde3f2bc26b0c5a25) )

	ROM_REGION16_LE( 0x280000, "textilemap", 0 ) // texture tilemap
	ROM_LOAD( "tw1ccrl.3d", 0x000000, 0x200000, CRC(d08f5794) SHA1(336a97a2b060505e259e3bcedb9eb8aa4ea8815e) ) // == tw1ccrl.7b
	ROM_LOAD( "tw1ccrh.1d", 0x200000, 0x080000, CRC(ad17e693) SHA1(4f06dc82c03159894fb8e10383862920f94563b1) ) // == tw1ccrh.5b
	ROM_LOAD( "tw1ccrl.7b", 0x000000, 0x200000, CRC(d08f5794) SHA1(336a97a2b060505e259e3bcedb9eb8aa4ea8815e) )
	ROM_LOAD( "tw1ccrh.5b", 0x200000, 0x080000, CRC(ad17e693) SHA1(4f06dc82c03159894fb8e10383862920f94563b1) )
...
ROM_START( tokyowarj )
	ROM_REGION( 0x400000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "tw1vera.1", 0x000003, 0x100000, CRC(29b38f05) SHA1(d55a34dce5f61d72e3edc331d3a346397069a5fc) )
	ROM_LOAD32_BYTE( "tw1vera.2", 0x000002, 0x100000, CRC(5f8e2e9e) SHA1(14513480fed483e5381ac5bf4467a1c17b0d9e75) )
	ROM_LOAD32_BYTE( "tw1vera.3", 0x000001, 0x100000, CRC(17146e7f) SHA1(0fd270152eef1966e0960531554cbe115668205f) )
	ROM_LOAD32_BYTE( "tw1vera.4", 0x000000, 0x100000, CRC(12698e2a) SHA1(51761ea96cb458f56d832cd233afbc374ded7f20) )
...
ROM_START( dirtdash )
	ROM_REGION( 0x400000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "dt2verc.rom1", 0x000003, 0x100000, CRC(b2d7916c) SHA1(4f4cb75ef12b57bdc12b6aba59678f09b22bcfce) )
	ROM_LOAD32_BYTE( "dt2verc.rom2", 0x000002, 0x100000, CRC(5dc040d1) SHA1(4b285d146adb0cff146b79d7471597148b3c4a97) )
	ROM_LOAD32_BYTE( "dt2verc.rom3", 0x000001, 0x100000, CRC(a55157e1) SHA1(ede052ad55430418905987b8bcba4aa229ac037c) )
	ROM_LOAD32_BYTE( "dt2verc.rom4", 0x000000, 0x100000, CRC(f3a9bedb) SHA1(71366108dec0803b585d409095f126cc55ec3e4d) )

	ROM_REGION16_LE( 0x080000, "mcu", 0 ) // S22-BIOS ver1.41
	ROM_LOAD( "dt1dataa.8k", 0x000000, 0x080000, CRC(9bcdea21) SHA1(26ae025cf746d3a703a82495eb2bb515b828a650) )

	ROM_REGION( 0x1000000, "sprite", ROMREGION_ERASEFF ) // 32x32x8bpp sprite tiles
	ROM_LOAD( "dt1scg0.12f", 0x000000, 0x200000, CRC(a09b5760) SHA1(3dd54ebebf9da1de76874a1adf491ed15849e1b1) ) // == dt1scg0.12l
	ROM_LOAD( "dt1scg1.10f", 0x200000, 0x200000, CRC(f9ac8111) SHA1(814074ae8cc81c6c1201d764a84dd95fe914f19c) ) // == dt1scg1.10l
	ROM_LOAD( "dt1scg0.12l", 0x000000, 0x200000, CRC(a09b5760) SHA1(3dd54ebebf9da1de76874a1adf491ed15849e1b1) )
	ROM_LOAD( "dt1scg1.10l", 0x200000, 0x200000, CRC(f9ac8111) SHA1(814074ae8cc81c6c1201d764a84dd95fe914f19c) )

	ROM_REGION( 0x1000000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "dt1cg0.8d",  0x000000, 0x200000, CRC(10ab95e0) SHA1(ffde1f00ac3e82a36fbcfa060c6b97c92dfcfc8b) ) // == dt1cg0.12b
	ROM_LOAD( "dt1cg1.10d", 0x200000, 0x200000, CRC(d9f1ba53) SHA1(5a1095b726c55001cc1d4c695adc38097e6a0201) ) // == dt1cg1.13b
	ROM_LOAD( "dt1cg2.12d", 0x400000, 0x200000, CRC(bd8b1e0b) SHA1(fcd94e33a0cbd17c9308cb8952e3c618ab56f9fc) ) // == dt1cg2.14b
	ROM_LOAD( "dt1cg3.13d", 0x600000, 0x200000, CRC(ba960663) SHA1(e98149bc4652ea7933ac47d760a6f7e6489f15e2) ) // == dt1cg3.16b
	ROM_LOAD( "dt1cg4.14d", 0x800000, 0x200000, CRC(424b9652) SHA1(fa8865110db03559740c4e633e123d1a009782c4) ) // == dt1cg4.18b
	ROM_LOAD( "dt1cg5.16d", 0xa00000, 0x200000, CRC(29516626) SHA1(1f12c5dc3975b88dc60d87d0409bf311837e9fa4) ) // == dt1cg5.19b
	ROM_LOAD( "dt1cg6.18d", 0xc00000, 0x200000, CRC(e6fa7180) SHA1(85316cde282cff1f913cf9f155cfa36adcc1108e) ) // == dt1cg6.18a
	ROM_LOAD( "dt1cg7.19d", 0xe00000, 0x200000, CRC(2ca19153) SHA1(c82403c8b40bf85daedf610b1bc7bfea9dfc6206) ) // == dt1cg7.15a
	ROM_LOAD( "dt1cg0.12b", 0x000000, 0x200000, CRC(10ab95e0) SHA1(ffde1f00ac3e82a36fbcfa060c6b97c92dfcfc8b) )
	ROM_LOAD( "dt1cg1.13b", 0x200000, 0x200000, CRC(d9f1ba53) SHA1(5a1095b726c55001cc1d4c695adc38097e6a0201) )
	ROM_LOAD( "dt1cg2.14b", 0x400000, 0x200000, CRC(bd8b1e0b) SHA1(fcd94e33a0cbd17c9308cb8952e3c618ab56f9fc) )
	ROM_LOAD( "dt1cg3.16b", 0x600000, 0x200000, CRC(ba960663) SHA1(e98149bc4652ea7933ac47d760a6f7e6489f15e2) )
	ROM_LOAD( "dt1cg4.18b", 0x800000, 0x200000, CRC(424b9652) SHA1(fa8865110db03559740c4e633e123d1a009782c4) )
	ROM_LOAD( "dt1cg5.19b", 0xa00000, 0x200000, CRC(29516626) SHA1(1f12c5dc3975b88dc60d87d0409bf311837e9fa4) )
	ROM_LOAD( "dt1cg6.18a", 0xc00000, 0x200000, CRC(e6fa7180) SHA1(85316cde282cff1f913cf9f155cfa36adcc1108e) )
	ROM_LOAD( "dt1cg7.15a", 0xe00000, 0x200000, CRC(2ca19153) SHA1(c82403c8b40bf85daedf610b1bc7bfea9dfc6206) )

	ROM_REGION16_LE( 0x280000, "textilemap", 0 ) // texture tilemap
	ROM_LOAD( "dt1ccrl.3d", 0x000000, 0x200000, CRC(e536b313) SHA1(7357da993d2bb3fcc8c1c2feb53689ad368cd80a) ) // == dt1ccrl.7b
	ROM_LOAD( "dt1ccrh.1d", 0x200000, 0x080000, CRC(af257064) SHA1(0da561d9f8824618c00209ccef6146e9f3ad72bb) ) // == dt1ccrh.5b
	ROM_LOAD( "dt1ccrl.7b", 0x000000, 0x200000, CRC(e536b313) SHA1(7357da993d2bb3fcc8c1c2feb53689ad368cd80a) )
	ROM_LOAD( "dt1ccrh.5b", 0x200000, 0x080000, CRC(af257064) SHA1(0da561d9f8824618c00209ccef6146e9f3ad72bb) )
...
ROM_START( dirtdashb )
	...
	ROM_LOAD32_BYTE( "dt2verb.rom3", 0x000001, 0x100000, CRC(f0d9aff2) SHA1(2ebccbd9524d29c12e001d897fd81948fb6068fa) )
...
ROM_START( aquajet )
	ROM_REGION( 0x400000, "maincpu", 0 ) // main program
	ROM_LOAD32_BYTE( "aj2verb.1", 0x000003, 0x100000, CRC(3a67b9f4) SHA1(8cd51f319e082297fdb99634486fe297a0ace654) )
	ROM_LOAD32_BYTE( "aj2verb.2", 0x000002, 0x100000, CRC(f5e8fc96) SHA1(e23fcf6f84724d1de15870ff578ff8a6b26e8f31) )
	ROM_LOAD32_BYTE( "aj2verb.3", 0x000001, 0x100000, CRC(ef6ebcf7) SHA1(358973b678b9a3065e945fb589af16e8102d437b) )
	ROM_LOAD32_BYTE( "aj2verb.4", 0x000000, 0x100000, CRC(7799b909) SHA1(e40005f96f51742b2778605926b8184c9b2c1ad2) )

	ROM_REGION16_LE( 0x080000, "mcu", 0 ) // S22-BIOS ver1.41
	ROM_LOAD( "aj1data.8k",  0x000000, 0x080000, CRC(52bcc6d5) SHA1(25319ea6db35cc9bdcb39cc83d597a2a9f1690f3) )

	ROM_REGION( 0x1000000, "sprite", ROMREGION_ERASEFF ) // 32x32x8bpp sprite tiles
	ROM_LOAD( "aj1scg0.12f", 0x000000, 0x200000, CRC(13ea766c) SHA1(a1a259bd8f468b90cbc891f1c2875fe03bba9802) ) // == aj1scg0.12l
	ROM_LOAD( "aj1scg1.10f", 0x200000, 0x200000, CRC(cb3638de) SHA1(0af99aaf00782036d7f479b00b0c3d9d7ad4fc37) ) // == aj1scg1.10l
	ROM_LOAD( "aj1scg2.8f",  0x400000, 0x200000, CRC(1048a09b) SHA1(6859533e24db5ac54e28d480aaac7b411a648dfe) ) // == aj1scg2.8l
	ROM_LOAD( "aj1scg0.12l", 0x000000, 0x200000, CRC(13ea766c) SHA1(a1a259bd8f468b90cbc891f1c2875fe03bba9802) )
	ROM_LOAD( "aj1scg1.10l", 0x200000, 0x200000, CRC(cb3638de) SHA1(0af99aaf00782036d7f479b00b0c3d9d7ad4fc37) )
	ROM_LOAD( "aj1scg2.8l",  0x400000, 0x200000, CRC(1048a09b) SHA1(6859533e24db5ac54e28d480aaac7b411a648dfe) )

	ROM_REGION( 0x1000000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "aj1cg0.8d",  0x000000, 0x200000, CRC(b814e1eb) SHA1(1af29897dcfd0a58743b4fcdd5049d9e6e3d4cbd) ) // == aj1cg0.12b
	ROM_LOAD( "aj1cg1.10d", 0x200000, 0x200000, CRC(dc63d496) SHA1(d3c3eea6b134850004062dd513c0f26096101227) ) // == aj1cg1.13b
	ROM_LOAD( "aj1cg2.12d", 0x400000, 0x200000, CRC(71fbb571) SHA1(40f84ab5a4a7bb4438fb53751762609671d17800) ) // == aj1cg2.14b
	ROM_LOAD( "aj1cg3.13d", 0x600000, 0x200000, CRC(e28052e2) SHA1(3dbc446d7a13312ed4c1d20c2e1209947853f2c4) ) // == aj1cg3.16b
	ROM_LOAD( "aj1cg4.14d", 0x800000, 0x200000, CRC(c77ae1a0) SHA1(e15f2ccbadb8634f6e5cfd2cf48f428d68bd92e1) ) // == aj1cg4.18b
	ROM_LOAD( "aj1cg5.16d", 0xa00000, 0x200000, CRC(15be0080) SHA1(ca14dfd2a66996f0b32fa1155c04f21d300e8f30) ) // == aj1cg5.19b
	ROM_LOAD( "aj1cg6.18d", 0xc00000, 0x200000, CRC(1a4f733a) SHA1(60a991f06e73667fa2c9016189999c4301cba24f) ) // == aj1cg6.18a
	ROM_LOAD( "aj1cg7.19d", 0xe00000, 0x200000, CRC(ea118130) SHA1(24ef22e5c8c6f6e8a01c72466be1e7acbfba63bc) ) // == aj1cg7.15a
	ROM_LOAD( "aj1cg0.12b", 0x000000, 0x200000, CRC(b814e1eb) SHA1(1af29897dcfd0a58743b4fcdd5049d9e6e3d4cbd) )
	ROM_LOAD( "aj1cg1.13b", 0x200000, 0x200000, CRC(dc63d496) SHA1(d3c3eea6b134850004062dd513c0f26096101227) )
	ROM_LOAD( "aj1cg2.14b", 0x400000, 0x200000, CRC(71fbb571) SHA1(40f84ab5a4a7bb4438fb53751762609671d17800) )
	ROM_LOAD( "aj1cg3.16b", 0x600000, 0x200000, CRC(e28052e2) SHA1(3dbc446d7a13312ed4c1d20c2e1209947853f2c4) )
	ROM_LOAD( "aj1cg4.18b", 0x800000, 0x200000, CRC(c77ae1a0) SHA1(e15f2ccbadb8634f6e5cfd2cf48f428d68bd92e1) )
	ROM_LOAD( "aj1cg5.19b", 0xa00000, 0x200000, CRC(15be0080) SHA1(ca14dfd2a66996f0b32fa1155c04f21d300e8f30) )
	ROM_LOAD( "aj1cg6.18a", 0xc00000, 0x200000, CRC(1a4f733a) SHA1(60a991f06e73667fa2c9016189999c4301cba24f) )
	ROM_LOAD( "aj1cg7.15a", 0xe00000, 0x200000, CRC(ea118130) SHA1(24ef22e5c8c6f6e8a01c72466be1e7acbfba63bc) )

	ROM_REGION16_LE( 0x280000, "textilemap", 0 ) // texture tilemap
	ROM_LOAD( "aj1ccrl.3d", 0x000000, 0x200000, CRC(3cc7a247) SHA1(336e4dd506d932987e20a5890dd3b0db75c02ccf) ) // == aj1ccrl.7b
	ROM_LOAD( "aj1ccrh.1d", 0x200000, 0x080000, CRC(9d936030) SHA1(a383bcca494a9f8d9a08fbe9940c8071d4525d65) ) // == aj1ccrh.5b
	ROM_LOAD( "aj1ccrl.7b", 0x000000, 0x200000, CRC(3cc7a247) SHA1(336e4dd506d932987e20a5890dd3b0db75c02ccf) )
	ROM_LOAD( "aj1ccrh.5b", 0x200000, 0x080000, CRC(9d936030) SHA1(a383bcca494a9f8d9a08fbe9940c8071d4525d65) )
...
ROM_START( adillor )
	...
	ROM_REGION( 0x1000000, "sprite", ROMREGION_ERASEFF ) // 32x32x8bpp sprite tiles
	ROM_LOAD( "am1scg0.12f", 0x000000, 0x200000, CRC(e576f993) SHA1(704645c2b2af4d3f6b77f2299cd7277837e204d2) ) // == am1scg0.12l
	ROM_LOAD( "am1scg1.10f", 0x200000, 0x200000, CRC(d6d26cc1) SHA1(1da35ec2f89cfc5778d81b6a892fcf100d6e9933) ) // == am1scg1.10l
	...
	ROM_REGION( 0x1000000, "textile", 0) // 16x16x8bpp texture tiles
	ROM_LOAD( "am1cg0.8d",  0x000000, 0x200000, CRC(b91e4259) SHA1(3de7fee2be9843ef6a8718f9dcbc3aeb1fb23b64) ) // == am1cg0.12b
	ROM_LOAD( "am1cg1.10d", 0x200000, 0x200000, CRC(c1b82a26) SHA1(25dc3cdf5fe18de89e6d7304ff76b6157aba2cd6) ) // == am1cg1.13b
	ROM_LOAD( "am1cg2.12d", 0x400000, 0x200000, CRC(36a7d3fd) SHA1(f07bb746f775d1eb70c4b6a65e6002d2136cfe4d) ) // == am1cg2.14b
	ROM_LOAD( "am1cg3.13d", 0x600000, 0x200000, CRC(8b0857ef) SHA1(1c86db318d7bb7bc303ba65a9db493b033035d7b) ) // == am1cg3.16b
	ROM_LOAD( "am1cg4.14d", 0x800000, 0x200000, CRC(ebc516fe) SHA1(585554f14cfdf69a89a6431867b7cfc1a9eae379) ) // == am1cg4.18b
	ROM_LOAD( "am1cg5.16d", 0xa00000, 0x200000, CRC(30fad30d) SHA1(bb0d9e2b479d83cc38ffd76d0d55f06dca0f304a) ) // == am1cg5.19b
	ROM_LOAD( "am1cg6.18d", 0xc00000, 0x200000, CRC(62eea883) SHA1(37e441bb1289e45ef3043f70f77646c15b6dff0e) ) // == am1cg6.18a
	ROM_LOAD( "am1cg7.19d", 0xe00000, 0x200000, CRC(2d257f47) SHA1(6406556b4b142b6c596eb25f407275a63f6a44f1) ) // == am1cg7.15a
	...
	ROM_LOAD( "am1cg4.18b", 0x800000, 0x200000, CRC(ebc516fe) SHA1(585554f14cfdf69a89a6431867b7cfc1a9eae379) )
	...
	ROM_LOAD( "am1ccrl.3d", 0x000000, 0x200000, CRC(76c6d5f3) SHA1(637efe30d004a9c42864b7536e02e9805ed9b6ef) ) // == am1ccrl.7b
	ROM_LOAD( "am1ccrh.1d", 0x200000, 0x080000, CRC(180c4a33) SHA1(5e0818ba8a135c51953bc3bc5c4a1475f7f93eff) ) // == am1ccrh.5b
