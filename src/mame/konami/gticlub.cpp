...
public:
	...
	void slrasslt(machine_config &config) ATTR_COLD;
	void gticlub(machine_config &config) ATTR_COLD;
...
public:
	...
	void thunderh(machine_config &config) ATTR_COLD;
...
public:
	...
	void hangplt(machine_config &config) ATTR_COLD;

	void init_hangplt_common() ATTR_COLD;
	void init_hangplt() ATTR_COLD;
	void init_hangpltu() ATTR_COLD;
...
GAME( 1996, gticlub,    0,        gticlub,  gticlub,  gticlub_state,  empty_init,    ROT0, "Konami", "GTI Club: Rally Cote D'Azur (ver EAA)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )
GAME( 1996, gticlubu,   gticlub,  gticlub,  gticlub,  gticlub_state,  empty_init,    ROT0, "Konami", "GTI Club: Rally Cote D'Azur (ver UAA)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )
GAME( 1996, gticluba,   gticlub,  gticlub,  gticlub,  gticlub_state,  empty_init,    ROT0, "Konami", "GTI Club: Rally Cote D'Azur (ver AAA)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )
GAME( 1996, gticlubj,   gticlub,  gticlub,  gticlub,  gticlub_state,  empty_init,    ROT0, "Konami", "GTI Club: Rally Cote D'Azur (ver JAA)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )
GAME( 1997, thunderh,   0,        thunderh, thunderh, thunderh_state, empty_init,    ROT0, "Konami", "Operation Thunder Hurricane (ver EAA)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )
GAME( 1997, thunderhu,  thunderh, thunderh, thunderh, thunderh_state, empty_init,    ROT0, "Konami", "Operation Thunder Hurricane (ver UAA)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )
GAME( 1997, slrasslt,   0,        slrasslt, slrasslt, gticlub_state,  empty_init,    ROT0, "Konami", "Solar Assault (ver UAA)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND ) // Based on Revised code
GAME( 1997, slrassltj,  slrasslt, slrasslt, slrasslt, gticlub_state,  empty_init,    ROT0, "Konami", "Solar Assault Revised (ver JAA)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )
GAME( 1997, slrassltj1, slrasslt, slrasslt, slrasslt, gticlub_state,  empty_init,    ROT0, "Konami", "Solar Assault (ver JAA)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )
