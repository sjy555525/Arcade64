...
GAME( 1995, midnrun,   0,        midnrun, midnrun,  midnrun_state, empty_init,  ROT0, "Konami", "Midnight Run: Road Fighter 2 (EAA, Euro v1.11)", MACHINE_IMPERFECT_GRAPHICS )
GAME( 1995, midnrunj,  midnrun,  midnrun, midnrun,  midnrun_state, empty_init,  ROT0, "Konami", "Midnight Run: Road Fighter 2 (JAD, Japan v1.10)", MACHINE_IMPERFECT_GRAPHICS )
GAME( 1995, midnruna,  midnrun,  midnrun, midnrun,  midnrun_state, empty_init,  ROT0, "Konami", "Midnight Run: Road Fighter 2 (AAA, Asia v1.10, older sound program)", MACHINE_IMPERFECT_GRAPHICS )
GAME( 1995, midnruna2, midnrun,  midnrun, midnrun,  midnrun_state, empty_init,  ROT0, "Konami", "Midnight Run: Road Fighter 2 (AAA, Asia v1.10, newer sound program)", MACHINE_IMPERFECT_GRAPHICS )
GAME( 1996, windheat,  0,        midnrun, midnrun,  midnrun_state, empty_init,  ROT0, "Konami", "Winding Heat (EAA, Euro v2.11)", MACHINE_IMPERFECT_GRAPHICS )
GAME( 1996, windheatu, windheat, midnrun, midnrun,  midnrun_state, empty_init,  ROT0, "Konami", "Winding Heat (UBC, USA v2.22)", MACHINE_IMPERFECT_GRAPHICS )
GAME( 1996, windheatj, windheat, midnrun, midnrun,  midnrun_state, empty_init,  ROT0, "Konami", "Winding Heat (JAA, Japan v2.11)", MACHINE_IMPERFECT_GRAPHICS )
GAME( 1996, windheata, windheat, midnrun, midnrun,  midnrun_state, empty_init,  ROT0, "Konami", "Winding Heat (AAA, Asia v2.11)", MACHINE_IMPERFECT_GRAPHICS )
GAME( 1996, jetwave,   0,        jetwave, jetwave,  jetwave_state, empty_init,  ROT0, "Konami", "Jet Wave (EAB, Euro v1.04)", MACHINE_IMPERFECT_GRAPHICS )
GAME( 1996, waveshrk,  jetwave,  jetwave, jetwave,  jetwave_state, empty_init,  ROT0, "Konami", "Wave Shark (UAB, USA v1.04)", MACHINE_IMPERFECT_GRAPHICS )
GAME( 1996, jetwavej,  jetwave,  jetwave, jetwave,  jetwave_state, empty_init,  ROT0, "Konami", "Jet Wave (JAB, Japan v1.04)", MACHINE_IMPERFECT_GRAPHICS )
