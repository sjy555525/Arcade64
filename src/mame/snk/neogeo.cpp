...
GAME( 1991, legendos,   neogeo,   neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "SNK / Wave", "Legend of Success Joe / Ashita no Joe Densetsu", MACHINE_SUPPORTS_SAVE )
...
GAME( 1996, kof96a,     kof96,    neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "SNK", "The King of Fighters '96 (bug fix revision)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1997, puzzldpr,   neogeo,   neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "Visco", "Puzzle De Pon! R!", MACHINE_SUPPORTS_SAVE ) // game concept licensed from Taito
GAME( 1998, breakrev,   neogeo,   neobase,   neogeo,    mvs_led_state, empty_init, ROT0, "Visco", "Breakers Revenge", MACHINE_SUPPORTS_SAVE )
GAME( 1998, flipshot,   neogeo,   neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "Visco", "Flip Shot", MACHINE_SUPPORTS_SAVE )
