...
static INPUT_PORTS_START( wwthomas )
	PORT_INCLUDE( system16b_generic )
	...
	PORT_MODIFY("P1")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON3 ) // 'Card Pos'
	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_BUTTON4 ) // 'Card Pay'
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON5 ) // 'Card Emp'
	...
	PORT_MODIFY("UNUSED") // not really
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_NAME("Whistle")
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_NAME("Steam")
	...
	PORT_DIPSETTING(       0x07, DEF_STR( 4C_1C ) )
	PORT_DIPSETTING(       0x08, DEF_STR( 3C_1C ) )
	PORT_DIPSETTING(       0x0f, DEF_STR( 2C_1C ) )
	...
	PORT_DIPSETTING(    0x00, "Coin" )
	PORT_DIPSETTING(    0x04, "100 - 400 Yen" )
	PORT_DIPNAME( 0x08, 0x08, "Card Holding Time" ) PORT_DIPLOCATION("SW2:4")
	PORT_DIPSETTING(    0x08, DEF_STR( Normal ) )
...
static GFXDECODE_START( gfx_lockonph )
	GFXDECODE_ENTRY( "tiles", 0, gfx_8x8x4_planar,   0, 1024 )
GFXDECODE_END
...
ROM_START( bullet )
	...
	ROM_REGION16_BE( 0x80000, "sprites", ROMREGION_ERASE00 )
...
ROM_START( dddoor )
	...
	ROM_REGION16_BE( 0x180000, "sprites", 0 )
...
ROM_START( fpointbla )
	...
	ROM_REGION16_BE( 0x10000, "sprites", 0 )
...
//*************************************************************************************************************************
//*************************************************************************************************************************
//  Waku Waku Thomas (わくわくトーマス), Sega System 16B
//  CPU: 68000
//  ROM Board type: 834-9742 sticker
//
ROM_START( wwthomas )
	ROM_REGION( 0x80000, "maincpu", 0 ) // 68000 code
	ROM_LOAD16_BYTE( "epr-15843.ic1",  0x00001, 0x40000, CRC(3b1bc91c) SHA1(5dc7f69ba461d57a90844d0accdc4fb618f1de69) )
	ROM_LOAD16_BYTE( "epr-15844.ic2",  0x00000, 0x40000, CRC(d6cc327e) SHA1(325c254f9aa03b46a5e280bfa48416b988ce0a13) )

	ROM_REGION( 0x60000, "tiles", 0 )
	ROM_LOAD( "epr-15849.ic19", 0x00000, 0x20000, CRC(733b7b96) SHA1(58b3b65f67db31da517ef9f7ae75ea728c236f9c) )
	ROM_LOAD( "epr-15850.ic20", 0x20000, 0x20000, CRC(3c9450c3) SHA1(9f7b124484ff0b2613fdd192009e087a689783f8) )
	ROM_LOAD( "epr-15851.ic21", 0x40000, 0x20000, CRC(5cc1075f) SHA1(ad33ccfd9a3b7ac32edb0b3258538039c7709290) )

	ROM_REGION16_BE( 0x140000, "sprites", 0 )
	ROM_LOAD16_BYTE( "epr-15847.ic9",  0x000001, 0x20000, CRC(409d7636) SHA1(98b85491b75bf34b4dbd51278be8b05db5c7791a) )
	ROM_CONTINUE(                      0x100001, 0x20000 )
	ROM_LOAD16_BYTE( "epr-15848.ic12", 0x000000, 0x20000, CRC(310625ea) SHA1(1c9081f3fde28790ef7eb965223fb2a6868819aa) )
	ROM_CONTINUE(                      0x100000, 0x20000 )

	ROM_REGION( 0x50000, "soundcpu", 0 )
	ROM_LOAD( "epr-18846.ic8", 0x00000,  0x08000, CRC(84b541a2) SHA1(bf8bf329b4ecc7061072cc00b9a1c41528fa112f) )
	ROM_LOAD( "epr-15845.ic6", 0x10000,  0x40000, CRC(9d6939ce) SHA1(d9494bc53f9a38d9e58f42e72430f8d41f5e11ba) )
ROM_END
...
ROM_START( wfishing ) // First release was Dec. 1993 so this is probably a later revision
	...
	ROM_REGION( 0xc0000, "tiles", ROMREGION_ERASE00 )
...
GAME( 1993, wwthomas,   0,        system16b_5797,        wwthomas, segas16b_state, init_generic_5797,       ROT0,   "Banpresto", "Waku Waku Thomas (Japan)", MACHINE_NOT_WORKING ) // card dispenser not hooked up
